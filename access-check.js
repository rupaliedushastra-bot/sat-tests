...
(async function checkAccess() {
    ...
    if (window.location.pathname.match(/\/(topic|test_6|wic|text_structure_purpose|cross_text_connections|Central_Ideas_and_Details|coe_textual|inferences|verbs|modifiers|plural_poss|transition|rhetorics|exam_sat_diag|angles|mensuration|trigonometry)/i)) {
        loginUrl = '../login.html';
        indexUrl = '../index.html';
    }
    ...
    const isMath = pathname.match(/\/(topic_9|topic_10|topic_11|topic_12|topic_13|topic_14|topic_15|topic_16|angles|mensuration|trigonometry)\//i);
