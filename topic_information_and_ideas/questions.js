// =============================================
// Digital SAT Practice - Topic: topic_information_and_ideas
// 25 Questions
// =============================================
...
const QUESTIONS = [
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. The text states that Whitman \"never learned the native language and refused to adopt any of the local culture.\" In other words, she did not make efforts to assimilate into Native American culture. Choice B is incorrect because having a child was not presented as a drawback. Choice C is incorrect because stopping in Washington is unrelated to the cultural integration problem. Choice D is unsupported by the passage.",
    "topic": "Central Ideas and Details"
  },
  {
    "id": 25,
