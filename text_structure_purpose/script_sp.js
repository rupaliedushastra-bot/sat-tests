// =============================================
// script_sp.js – Text Structure and Purpose Topic Test
// Digital SAT Practice | EduQuest
// =============================================

// ── Supabase Config (shared via supabase.js) ─
...
function downloadPDF() {
  ...
  html2pdf().set({
    margin: [10, 10, 10, 10],
    filename: `EduQuest_Report_${student.name.replace(/[^a-zA-Z0-9]/g, '_')}_TSP.pdf`,
