// =============================================
// Digital SAT – Topic Test: Advanced Math
// 25 Questions | Single Timed Module (35 min)
// answers: 0=A, 1=B, 2=C, 3=D
// Covers quadratic formula, exponential functions, systems of equations
// (linear & nonlinear), rational expressions, exponent rules,
// function composition, and domain/range
...
const QUESTIONS = [
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. For 2x² − 4x − 6 = 0, a = 2, b = −4, c = −6. The quadratic formula gives x = (−b ± √(b² − 4ac)) / (2a) = (4 ± √(16 + 48)) / 4 = (4 ± √64) / 4 = (4 ± 8) / 4. This gives x = 12/4 = 3 or x = −4/4 = −1. B), C), D) Incorrect; sign errors when applying the quadratic formula.",
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. For x² + 6x + 9 = 0, a = 1, b = 6, c = 9. The discriminant is b² − 4ac = 6² − 4(1)(9) = 36 − 36 = 0. A discriminant of 0 means the equation has exactly one real (repeated) solution. B), C), D) Incorrect; result from arithmetic errors when computing b² − 4ac.",
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. To complete the square for x² + 8x + 10, take half of 8 (which is 4), square it (16), and rewrite: x² + 8x + 16 − 16 + 10 = (x + 4)² − 6. B) Incorrect; sign error on the constant. C) Incorrect; uses 8 instead of half of 8 inside the parentheses. D) Incorrect; subtracts the original constant instead of (16 − 10).",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. From the second equation, solve for x: x = y + 2. Substitute into the first equation: 2(y + 2) + 3y = 6, which gives 2y + 4 + 3y = 6, so 5y + 4 = 6. Subtracting 4 gives 5y = 2, so y = 0.4. A), C), D) Incorrect; arithmetic errors when solving the resulting linear equation for y.",
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. Substitute y = 0.4 into x = y + 2: x = 0.4 + 2 = 2.4. A), B), D) Incorrect; arithmetic errors when substituting the value of y back into the equation for x.",
    "topic": "Systems of Equations (Substitution)"
  },
  {
    "id": 9,
    ...
    "answer": 2,
    "explanation": "Choice C is correct. Subtract the second equation from the first to eliminate x: (3x + 2y) − (3x − y) = 16 − 4, which gives 3y = 12, so y = 4. A), B), D) Incorrect; arithmetic errors when subtracting the equations or solving for y.",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. Factor the numerator: x² + 5x + 6 = (x + 2)(x + 3). Cancel the common factor (x + 2) from the numerator and denominator (since x ≠ −2): (x + 2)(x + 3)/(x + 2) = x + 3. A) Incorrect; this is the factor that gets canceled, not the simplified result. C), D) Incorrect; do not correctly factor the numerator.",
    "topic": "Rational Expressions"
  },
  {
    "id": 14,
    ...
    "answer": 1,
    "explanation": "Choice B is correct. A rational expression is undefined when its denominator equals zero. Setting x − 3 = 0 gives x = 3, so x = 3 must be excluded from the domain. A), C), D) Incorrect; none of these values make the denominator (x − 3) equal to zero.",
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. A vertical asymptote occurs where the denominator of a rational function equals zero (making the function undefined). For y = 1/(x − 2), setting x − 2 = 0 gives x = 2, which matches the dashed line shown in the graph. B) Incorrect; the y-intercept occurs at x = 0, not x = 1, and is unrelated to the vertical asymptote. C) Incorrect; the numerator (1) never equals zero, so this is not the source of the asymptote. D) Incorrect; x = −2 does not make the denominator (x − 2) equal to zero.",
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. First simplify each factor: (x²y³)² = x⁴y⁶, and (x³y)² = x⁶y². Then multiply, adding the exponents of like bases: x⁴y⁶ · x⁶y² = x^(4+6)·y^(6+2) = x¹⁰y⁸. B), C), D) Incorrect; arithmetic errors when applying the power rule and product rule for exponents.",
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. When multiplying powers with the same base, add the exponents: x⁻³ · x⁵ = x^(−3+5) = x². B) Incorrect; sign error when adding the exponents. C) Incorrect; this would result from incorrectly subtracting (5 − (−3)) and treating the result as a positive multiplication exponent rather than the sum −3+5. D) Incorrect; this would result from incorrectly multiplying the exponents instead of adding them.",
    "topic": "Exponent Rules"
  },
  {
    "id": 18,
    ...
    "answer": 2,
    "explanation": "Choice C is correct. To solve √(x + 5) = 3, square both sides: x + 5 = 3² = 9. Subtracting 5 from both sides gives x = 4. Checking: √(4 + 5) = √9 = 3, which confirms the solution. Choices A, B, and D are incorrect arithmetic errors that do not satisfy the original radical equation.",
  ...
  },
  {
    ...
    "answer": 3,
    "explanation": "Choice D is correct. Square both sides of √(2x − 3) = 5 to get 2x − 3 = 25. Adding 3 to both sides gives 2x = 28. Dividing by 2 gives x = 14. Checking: √(2(14) − 3) = √25 = 5, which confirms the solution. Choices A, B, and C are incorrect arithmetic errors when isolating x after squaring.",
    "topic": "Radical Equations"
  },
  {
    "id": 20,
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. To find g(f(x)), substitute f(x) = x + 1 into g(x) = x² in place of x: g(f(x)) = g(x + 1) = (x + 1)². A) Incorrect; this would be f(g(x)) = g(x) + 1 = x² + 1, applying the functions in the wrong order. C), D) Incorrect; do not correctly apply the composition of functions.",
    "topic": "Function Composition"
  },
  {
    "id": 22,
    ...
    "answer": 0,
    "explanation": "Choice A is correct. The function f(x) = x² is defined for every real number input — there are no restrictions, since squaring any real number is always possible. B), C) Incorrect; the domain (input values) is not restricted to non-negative or non-positive numbers; it is the range (output values) that is restricted to y ≥ 0. D) Incorrect; x = 0 is a valid input (f(0) = 0), so it should not be excluded.",
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. The function f(x) = (x − 2)² − 1 is a parabola that opens upward with its vertex (minimum point) at (2, −1), as shown in the graph. Since the parabola opens upward, the minimum y-value is −1, and y can take any value greater than or equal to −1. Therefore, the range is y ≥ −1. B) Incorrect; this would be the range if the parabola opened downward. C) Incorrect; while the domain of this function is all real numbers, the range is restricted because the parabola has a minimum value. D) Incorrect; 2 is the x-coordinate of the vertex, not a bound on the y-values.",
    "topic": "Domain and Range"
  },
  {
    "id": 24,
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. Since 32 = 2⁵ (2 × 2 × 2 × 2 × 2 = 32), and 2ˣ = 32 = 2⁵, the exponents must be equal: x = 5. A), C) Incorrect; do not satisfy 2ˣ = 32 (2⁴ = 16 and 2⁶ = 64). D) Incorrect; this confuses the value 32 with the exponent x itself.",
