...
const QUESTIONS = [
  ...
  },
  {
    ...
    options: ['(2, 3) and (-1, 0)', '(2, 3) only', '(-1, 0) only', '(1, 0) and (-2, -1)'],
    answer: 0,
  ...
  },
  {
    ...
    options: ['y ≥ -1', 'y ≤ -1', 'All real numbers', 'y ≥ 2'],
    answer: 0,
  ...
  },
  {
    ...
    options: ['Linear function', 'Quadratic function', 'Exponential function', 'Rational function'],
    answer: 2,
