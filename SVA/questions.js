...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "The subject is 'The number' (singular), not 'bands'. 'The number of...' always takes a singular verb. So the correct verb is 'is astonishing'. Answer: C.",
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "The subject is 'Both the egg and the eggplant' — a compound subject joined by 'and', which requires a plural verb. 'Are very' is correct. The relative clause 'which have little in common' does not affect the subject. Answer: B.",
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "The subject is 'Sitting on the couch and watching TV' — two gerund phrases joined by 'and', making a compound subject that requires a plural verb 'were'. Also, the complement 'the best ways' (plural) confirms plurality. Answer: C.",
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "'Arching their backs and hissing' describes a single combined behavior, so it takes the singular verb 'is'. The complement 'a behavior' (singular) also supports this. NO CHANGE is correct. Answer: A.",
        topic: "Gerund Phrases as Subjects"
    },
    {
        id: 5,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "'A number of' (as opposed to 'the number of') means 'several' and takes a plural verb. 'A number of people are seeking' is correct. NO CHANGE is the right answer. Answer: A.",
        topic: "The number of / A number of"
    },
    {
        id: 6,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "In sentences beginning with 'There', the verb must agree with the true subject that follows. The true subject is 'more than two decades' (plural), so the verb must be plural: 'There are'. Answer: C.",
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "The subject is 'Two writers' (plural). The prepositional phrase 'with unbelievable audacity' is a modifier and does not change the subject. 'Were claiming' correctly agrees with the plural subject. NO CHANGE is correct. Answer: A.",
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "'Everyone' is an indefinite pronoun that always takes a singular verb ('is'). The pronoun reference should also be singular ('his or her desk'). 'Everyone in the company is clearing out his or her desk' is correct. Answer: C.",
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "The subject is 'The school' (singular collective noun). A school of fish acts as a single unit, so the singular verb 'was' is required. 'Was easily seen' is correct. Answer: D.",
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "The subject is 'debt' (singular). The relative clause 'which grew rapidly...' is a modifier. The main verb must agree with the singular subject 'debt'. 'Was what ruined him' is correct. Answer: B.",
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "The subject is 'The vote' (singular). The modifying clause 'of the American people, who turned out in record numbers' does not change the subject. The singular verb 'demonstrates' is required. A comma before 'demonstrates' correctly follows the modifying clause. Answer: B.",
        topic: "Intervening Clauses"
    },
    {
        id: 12,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "The subject is 'compositions' (plural). The verb must be plural: 'are proof'. Also, 'simultaneously' already means 'at the same time', so 'at the same time simultaneously' (B) is redundant. 'Are proof that music can be both' is concise and correct. Answer: D.",
        topic: "Intervening Clauses"
    },
    {
        id: 13,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "The subject is 'The field' (singular). The clause 'which some laypeople simply call pottery' is a non-restrictive modifier and does not affect agreement. The singular verb 'is' is required. Answer: B.",
        topic: "Intervening Clauses"
    },
    {
        id: 14,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "The subject is 'The use' (singular). The prepositional phrase 'of various drinking vessels for different dining situations' is a modifier. The singular verb 'is' is required. Answer: C.",
        topic: "Intervening Phrases"
    },
    {
        id: 15,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "The subject is the gerund phrase 'going to the horse races', which is singular and takes the singular verb 'is'. Choice C is correct and maintains consistent pronoun use with 'your'. Answer: C.",
        topic: "Gerund Phrases as Subjects"
    },
    {
        id: 16,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "With 'neither...nor', the verb agrees with the subject closest to the verb. 'Drinking alcoholic beverages' is closest and is singular (a gerund phrase), so the verb must be singular: 'is'. Also, parallel structure requires both to be gerunds: 'smoking' and 'drinking'. Answer: D.",
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "This is an inverted sentence. The true subject comes after the verb: 'the trickle of snowmelt and the roaring river' — a compound subject (plural). The verb must be plural: 'run'. Answer: B.",
        topic: "Inverted Sentences (There is/are)"
    },
    {
        id: 18,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "The subject is 'The condensation' (singular). The relative clause 'that forms on cold glasses' modifies 'condensation' but does not change the subject. The singular verb 'has' is correct. NO CHANGE. Answer: A.",
        topic: "Intervening Clauses"
    },
    {
        id: 19,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'Neither' as a pronoun is always singular and takes a singular verb. 'Neither is going' is correct. The original clause is separated from the preceding clause by a comma (not 'but'), so the comma should be retained. Answer: D.",
        topic: "Indefinite Pronouns"
    },
    {
        id: 20,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "The subject is 'one' (singular), not 'doctors'. 'One in five doctors' means one person out of five, so the singular verb 'agrees' is correct. NO CHANGE. Answer: A.",
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "The subject is 'The collection' (singular), which requires a singular verb 'is'. Choice D inverts the sentence but correctly uses the singular 'is' to agree with the singular subject 'the collection'. It is also the most grammatically complete and clear. Answer: D.",
        topic: "Intervening Phrases"
    },
    // ── Section 3 ────────────────────────────────
    {
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "'Chance' (singular) takes the singular verb 'is'. 'No chances' is also grammatically awkward here since 'chance' is used in the abstract singular sense. 'There is no chance that' is correct. Answer: C.",
        topic: "Inverted Sentences (There is/are)"
    },
    {
        id: 23,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "'Faculty' is a collective noun that, in American English, is treated as singular and takes a singular verb 'has'. 'The faculty has approved the measure to increase' is correct. NO CHANGE. Answer: A.",
        topic: "Collective Nouns"
    },
    {
        id: 24,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "'The number of' always takes a singular verb. The subject is 'The number' (singular), so 'has more than doubled' is correct. Answer: C.",
        topic: "The number of / A number of"
    },
    {
        id: 25,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "The subject is 'hopes' (plural). The long relative clause 'that the European Central Bank will reach a deal to help Spain and Italy borrow at cheaper rates' modifies 'hopes' but does not change its plurality. The plural verb 'have nudged' is required. Answer: B.",
        topic: "Intervening Clauses"
    },
    {
        id: 26,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "The subject is 'The three friends' (plural). 'Max included' is a parenthetical that doesn't affect the subject. The plural verb 'were supposed to meet' is correct. Answer: D.",
        topic: "Intervening Phrases"
    },
    {
        id: 27,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "The relative clause 'that keep...' refers to 'the factors' (plural), so the plural verb 'keep' is needed. Also, 'like' is used as a preposition, not a conjunction — 'as it did' is grammatically correct when comparing clauses. Answer: B.",
        topic: "Intervening Clauses"
    },
    {
        id: 28,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "'The Daughters of the American Revolution' is the name of a single organization (collective), treated as singular in this context. 'Admits' is the correct singular verb. The phrase 'only women' must come before 'who can prove' for clarity. NO CHANGE is correct. Answer: A.",
        topic: "Collective Nouns"
    },
    {
        id: 29,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "The subject is 'Some members' (plural). 'Of the tribe' is a prepositional phrase that does not change the subject. The plural verb 'have been protesting' is required. Answer: B.",
        topic: "Intervening Phrases"
    },
    {
        id: 30,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "The introductory clause 'After she attended the career fair' has 'she' as its subject referring to Philippa. To avoid a dangling modifier, the main clause must also have Philippa (or a pronoun referring to her) as the subject. 'Philippa had many more resources at her disposal' correctly makes Philippa the subject. Answer: D.",
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "The subject is 'The results' (plural). 'Of the study' is a prepositional phrase that doesn't change the subject. The plural verb 'indicate' is required. Also, 'reduction' (noun) is correct, not 'reducing' (gerund/participle). Answer: D (indicate a reduction).",
        topic: "Intervening Phrases"
    },
    // ── Section 4 ────────────────────────────────
    {
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "The subject is 'The president' (singular). 'Along with two vice presidents' is a parenthetical phrase (not a compound subject with 'and'), so it does not make the subject plural. The singular verb 'is elected' is correct. Answer: C.",
        topic: "Intervening Phrases"
    },
    {
        id: 33,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "'A number of' means 'several' and takes a plural verb. 'A number of colorful glass vases were displayed' is correct. NO CHANGE. Answer: A.",
        topic: "The number of / A number of"
    },
    {
        id: 35,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "'Neither' is an indefinite pronoun that is always singular and requires the singular verb 'was'. 'Neither of our school's students nominated for the national spelling bee was able to win' is correct. Answer: B.",
        topic: "Indefinite Pronouns"
    },
    {
        id: 36,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "'Everybody' is an indefinite pronoun that always takes a singular verb. 'Everybody loves' is correct. The modifier 'at the party' should stay close to 'Everybody'. Answer: C.",
        topic: "Indefinite Pronouns"
    },
    {
        id: 37,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "This is an inverted sentence. The true subject is 'two older women' (plural). In inverted sentences, the verb must agree with the true subject. 'On the bench sit two older women' uses the correct plural verb 'sit'. Answer: B.",
        topic: "Inverted Sentences (There is/are)"
    },
    {
        id: 38,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "In American English, 'the public' is a collective noun treated as singular, requiring 'is'. Since the mayor being unheard of is a past condition (prior to the election), the past tense 'was' is correct. 'The public is receiving the new mayor well though she was' is correct. Answer: C.",
        topic: "Collective Nouns"
    },
    {
        id: 39,
