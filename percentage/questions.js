// =============================================
// Digital SAT – Topic: Percentage
// questions.js | sat_percentage_questions.pdf
// 28 Questions | Made by Ranjit Sarangi
// =============================================
...
const QUESTIONS = [
    ...
    },
    {
        ...
        options: ["Rs. 10,000", "Rs. 10,075", "Rs. 10,100", "Rs. 10,500"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Rs. 1200", "Rs. 2400", "Rs. 3000", "Rs. 3200"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["1440", "1800", "3600", "Data inadequate"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["2382", "2450", "2518", "None of these"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["25000", "33000", "35000", "40000"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["40% pure", "50% pure", "51.2% pure", "58.8% pure"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Rs. 2", "Rs. 2.25", "Rs. 2.30", "Rs. 2.50"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Rs. 8.64", "Rs. 8.88", "Rs. 9.36", "Rs. 10.40"],
        answer: 2,
    ...
    },
    {
        ...
        options: ["Re. 0.50", "Re. 1", "Rs. 1.50", "Rs. 4.50"],
        answer: 0,
    ...
    {
        id: 26,
        text: `There are 600 boys in a hostel. Each plays either hockey or football or both. If 75% play hockey and 45% play football, how many play both?`,
        options: ["48", "60", "80", "120"],
        answer: 3,
        explanation: "Since every boy plays at least one: Hockey% + Football% − Both% = 100% → 75 + 45 − Both% = 100 → Both% = 20%. Boys who play both = 20% of 600 = 120. Answer: D.",
        topic: "Percentage – Sets & Venn Diagrams"
    },
    {
        id: 27,
        text: `In a certain office, 72% of the workers prefer tea and 44% prefer coffee. If each of them prefers tea or coffee and 40 like both, the total number of workers in the office is:`,
        options: ["200", "240", "250", "320"],
        answer: 2,
        explanation: "Since everyone prefers at least one: Tea% + Coffee% − Both% = 100% → 72 + 44 − Both% = 100 → Both% = 16%. 16% of total = 40 → Total = 40 ÷ 0.16 = 250. Answer: C.",
        topic: "Percentage – Sets & Venn Diagrams"
    },
    {
        id: 28,
        text: `In an examination, 65% students passed in Civics and 60% in History, 40% passed in both of these subjects. If 90 students failed in History and Civics both, then what is the total number of students?`,
        options: ["600", "650", "700", "750"],
        answer: 0,
        explanation: "Passed in at least one = 65% + 60% − 40% = 85%. Failed in both = 100% − 85% = 15% of total = 90. Total = 90 ÷ 0.15 = 600. Answer: A.",
        topic: "Percentage – Sets & Venn Diagrams"
    }
];
