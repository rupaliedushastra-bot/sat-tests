...
const QUESTIONS = [
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. Option A directly states the topic (second language) and the paragraph's focus (benefits: career opportunities and cognitive abilities). Option B addresses challenges, not benefits. Options C and D discuss timing and practice — neither introduces the benefits a paragraph would argue.",
    "topic": "Topic Sentence"
  },
  {
    "id": 3,
    ...
    "answer": 1,
    "explanation": "Choice B is correct. Option B names the subject (electric vehicles), signals the focus (advantages), and gives specific examples (environmental benefits, cost savings). Option A focuses on gasoline cars. Option C shifts to companies and energy broadly. Option D makes a general environmental appeal with no connection to electric vehicles specifically.",
    "topic": "Topic Sentence"
  },
  {
    "id": 4,
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. Option B makes a direct, evidence-based claim listing three specific benefits (mental health, energy levels, reduced disease risk). Options A and C describe preferences and habits without supporting any argument. Option D shifts to safety advice — tangential to exercise benefits.",
    "topic": "Supporting Evidence"
  },
  {
    "id": 10,
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. \"By analyzing the data thoroughly\" is a prepositional phrase explaining HOW (the method by which) the scientists drew accurate conclusions. It describes the means or process, not an example, a contrast, or a new topic.",
    "topic": "Sentence Function"
  },
  {
    "id": 12,
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. \"Because of her dedication\" is a causal phrase that directly states the reason why the team met its deadlines. \"Because of\" is one of the clearest cause-effect signals in English. It is not an example, contrast, or new topic — it explains the cause of the stated result.",
    "topic": "Sentence Function"
  },
  {
    "id": 14,
    ...
    "answer": 3,
    "explanation": "Choice D is correct. \"In addition to her many talents\" is an additive phrase — it signals that what follows is extra information layered on top of what is already known about her. It does not provide an example of volunteering, explain a reason, or introduce a contrast.",
    "topic": "Sentence Function"
  },
  {
    "id": 15,
    ...
    "answer": 0,
    "explanation": "Choice A is correct. \"By conducting a thorough review\" describes HOW the researcher ensured accuracy — it is a method phrase. \"By + gerund\" constructions in English typically explain the means or method used. It does not introduce contrast, give a specific data example, or present a new argument.",
    "topic": "Sentence Function"
  },
  {
    "id": 16,
    ...
    "answer": 2,
    "explanation": "Choice C is correct. A transition sentence must bridge two different ideas. Option C uses \"However\" to signal a pivot from benefits to challenges, and it explicitly introduces challenges (cost, infrastructure). Options A, B, and D all stay within the benefits/support territory and never pivot to challenges.",
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. Option C signals a pivot (\"however\") from the problem (challenges) to the solution territory (innovative planning, emissions standards). Options A and B continue describing the problem. Option D introduces ongoing research — a continuation, not a pivot toward solutions.",
    "topic": "Transitions Between Ideas"
  },
  {
    "id": 18,
    ...
    "answer": 2,
    "explanation": "Choice C is correct. \"However\" is the correct transition because it signals a contrast: the passage moves from initial positive findings (increased interaction) to contradictory recent findings (reduced productivity). \"Furthermore\" and \"In addition\" would add more of the same point. \"As a result\" would imply the noise causes more interaction, which contradicts the passage.",
    "topic": "Transitions Between Ideas"
  },
  {
    "id": 19,
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. Option C directly supports the argument for extending the school year by citing research evidence showing academic benefits (higher performance in core subjects). Options A, B, and D each provide reasons to oppose the extension — they would weaken the argument. A supporting sentence must align with and reinforce the paragraph's central claim.",
    "topic": "Supporting Evidence"
  }
];
