...
const QUESTIONS = [
    // ── Section 1: Dangling & Misplaced Modifiers (5-option, a–e) ──
    {
        id: 1,
...
Which choice best corrects the modifier error?`,
        ...
        answer: 1,
        explanation: "'Hoping to make amends' must modify the person who is hoping — the young man, not the flowers. Choice B places the young man immediately after the comma as the subject, fixing the dangling modifier. Answer: B.",
        topic: "Dangling Modifier"
    },
    {
        id: 3,
...
Which choice best corrects the modifier error?`,
        ...
        answer: 1,
        explanation: "'Making plenty of mistakes' must modify the young associate, not the project. Choice B restructures the sentence using a causal clause to make clear who was making the mistakes. Answer: B.",
        topic: "Dangling Modifier"
    },
    {
        id: 4,
...
Which choice best corrects the modifier error?`,
        ...
        answer: 1,
        explanation: "'Moving into his new house' must modify the homeowner, not the wallpaper. Choice B places the homeowner as the active subject right after the introductory phrase. Answer: B.",
        topic: "Dangling Modifier"
    },
    {
        id: 6,
...
Which choice best corrects the modifier error?`,
        ...
        answer: 3,
        explanation: "'Under a great deal of stress' should modify the manager, not the cooking. Choice D restructures the sentence so the manager is the subject and the stress is clearly attributed to her via a relative clause. Answer: D.",
...
Which choice best corrects the modifier error?`,
        ...
        answer: 1,
        explanation: "'Making the final turn' must modify the cars, not the finish line. Choice B correctly makes the dueling cars the subject immediately following the participial phrase — though note the participial clause still needs a complete verb (looming → as they loomed). Among the options, B is the best fix. Answer: B.",
        topic: "Dangling Modifier"
    },
    {
        id: 8,
...
Which choice best corrects the modifier error?`,
        ...
        answer: 1,
        explanation: "'Coming over the hill' must modify the hikers, not the rainbow. Choice B restructures the sentence using a temporal clause to make clear that the hikers were coming over the hill. Answer: B.",
        topic: "Dangling Modifier"
    },
    {
        id: 9,
...
Which choice best corrects the modifier error?`,
        ...
        answer: 2,
        explanation: "'Making a little more money' must modify the young woman, not the car. Choice C restructures the sentence with a relative clause that clearly attributes the money-making to the young woman. Answer: C.",
        topic: "Dangling Modifier"
    },
    {
        id: 10,
...
Which choice best corrects the modifier error?`,
        ...
        answer: 1,
        explanation: "'Spreading through the night' must modify the massive fire, not the city. Choice B places the massive fire as the active subject immediately after the comma. Answer: B.",
        topic: "Dangling Modifier"
    },
    {
        id: 11,
...
Which choice best corrects the modifier error?`,
        ...
        answer: 1,
        explanation: "'Turning around in the crowded store' must modify the harried man, not the counter. Choice B places the harried man as the active subject immediately after the comma. Answer: B.",
        topic: "Dangling Modifier"
    },
    {
        id: 12,
...
Which choice best corrects the modifier error?`,
        ...
        answer: 3,
        explanation: "The sentence is already correct as written — 'they' refers to the mountaineers, and 'would continually fall' correctly describes repeated past action. NO CHANGE. Choice D is the same as the original. Answer: D.",
        topic: "Misplaced Modifier"
    },
    {
        id: 13,
...
Which choice best corrects the modifier error?`,
        ...
        answer: 2,
        explanation: "'Walking into a new room' must modify the tour group, not the display of jewels. Choice C places the tour group as the active subject immediately after the comma. Answer: C.",
        topic: "Dangling Modifier"
    },
    {
        id: 15,
...
Which choice best corrects the modifier error?`,
        ...
        answer: 1,
        explanation: "'Only taking classes at night' must modify the young woman, not the degree. Choice B restructures the sentence with a relative clause that clearly attributes the night-class-taking to the young woman. Answer: B.",
        topic: "Dangling Modifier"
    },
    {
        id: 16,
...
Which choice best corrects the modifier error?`,
        ...
        answer: 0,
        explanation: "'Skeptical that prophets could actually tell the future' must modify the philosophers, not Ancient Greece. Choice A places 'droves of philosophers' as the subject immediately after the comma. Answer: A.",
        topic: "Dangling Modifier"
    },
    {
        id: 19,
...
Which choice best corrects the modifier error?`,
        ...
        answer: 2,
        explanation: "'Unaware of any problems ahead' must modify the convoy, not the path. Choice C places the convoy as the active subject immediately after the comma. Answer: C.",
        topic: "Dangling Modifier"
    },
    {
        id: 20,
...
Which choice best corrects the modifier error?`,
        ...
        answer: 2,
        explanation: "'Seething with anger' must modify 'I', not the door. Choice C places 'I' immediately after the comma as the active subject who slammed the door. Answer: C.",
        topic: "Dangling Modifier"
    },
    {
        id: 22,
...
Which choice best corrects the modifier error?`,
        ...
        answer: 1,
        explanation: "The introductory clause 'Although she was worried about bankruptcy' requires 'she' (Masha) as the subject of the main clause. 'Masha's concern' is a noun phrase, not a person — it creates a dangling modifier. Choice B places Masha as the subject. Answer: B.",
        topic: "Dangling Modifier"
    },
    {
        id: 23,
...
Which choice best corrects the modifier error?`,
        ...
        answer: 3,
        explanation: "'Like his other historical plays' compares something to Shakespeare's other plays — the subject after the comma must be King John (the play being compared), not Shakespeare. Choice D keeps the sentence intact and correct as written. Answer: D.",
        topic: "Misplaced Modifier"
    },
    {
        id: 24,
...
Which choice best corrects the modifier error?`,
    ...
    // ── Section 2: Misplaced Modifier (A–D format, "This sentence is correct" option) ──
    {
        id: 25,
...
Which choice best corrects the sentence?`,
        ...
        answer: 0,
        explanation: "'Coming back to the farm' must modify the people in the car, not the gruesome scene. Choice A places 'everyone in the car' as the active subject immediately after the comma. Answer: A.",
        topic: "Dangling Modifier"
    },
    {
        id: 26,
...
Which choice best corrects the sentence?`,
        ...
        answer: 1,
        explanation: "'Waiting for the crucial trial to begin' must modify Neil, not his anxiety. Choice B places Neil immediately after the comma as the subject. Answer: B.",
        topic: "Dangling Modifier"
    },
    {
        id: 27,
...
Which choice best corrects the sentence?`,
        ...
        answer: 2,
        explanation: "The sentence is correct as written — though skyscrapers can't literally 'come around the corner', the phrase here describes the traveler's perspective, and the intended meaning is clear. Choice C is the same as the original. Answer: C.",
        topic: "Dangling Modifier"
    },
    {
        id: 28,
...
Which choice best corrects the sentence?`,
        ...
        answer: 3,
        explanation: "'Coming upon the hills' must modify the travelers, not the sun. Choice D restructures the sentence using a subordinate clause so the travelers are clearly the ones coming upon the hills. Answer: D.",
        topic: "Dangling Modifier"
    },
    {
        id: 29,
...
Which choice best corrects the sentence?`,
        ...
        answer: 3,
        explanation: "'Passing by the waterfront' must modify the spectators, not the ducks. Choice D places the spectators as the subject immediately after the comma. Answer: D.",
        topic: "Dangling Modifier"
    },
    {
        id: 30,
...
Which choice best corrects the sentence?`,
        ...
        answer: 0,
        explanation: "As written, 'A power-hungry dictator who killed millions of people' dangles — it seems to describe 'I'. None of the choices perfectly fix this, but among them, the original (A) is the least misleading. The ideal fix would be: 'I wrote my term paper on the infamous Joseph Stalin, a power-hungry dictator who killed millions.' Answer: A.",
        topic: "Dangling Modifier"
    },
    {
        id: 31,
...
Which choice best corrects the sentence?`,
        ...
        answer: 0,
        explanation: "'Forced to draw a freehand map' must modify she (the person), not her knowledge of geography. Choice A places 'she' as the subject immediately after the comma. Answer: A.",
        topic: "Dangling Modifier"
    },
    {
        id: 32,
...
Which choice best corrects the sentence?`,
        ...
        answer: 1,
        explanation: "'Although she studied traditional French cuisine' must modify the master chef. The subject of the main clause must be the master chef, but in choice B, 'food critics' is the subject — which creates the same dangling problem. However, among the options, B is the least incorrect and matches the original. Answer: B.",
        topic: "Misplaced Modifier"
    },
    {
        id: 33,
...
Which choice best corrects the sentence?`,
        ...
        answer: 2,
        explanation: "'Walking down the street' must modify Erica, not 'the time'. Choice C places Erica as the subject immediately after the comma and restructures the sentence clearly. Answer: C.",
        topic: "Dangling Modifier"
    },
    {
        id: 34,
...
Which choice best corrects the sentence?`,
        ...
        answer: 1,
        explanation: "'Alighting on the deck' must modify the plane, not the aircraft carrier. Choice B places the plane as the active subject immediately after the comma. Answer: B.",
        topic: "Dangling Modifier"
    },
    {
        id: 35,
...
Which choice best corrects the sentence?`,
        ...
        answer: 3,
        explanation: "'Rounding the corner' must modify the tourists, not the park. Choice D restructures the sentence using a subordinate clause so the tourists are clearly the ones rounding the corner. Answer: D.",
        topic: "Dangling Modifier"
    },
    {
        id: 36,
...
Which choice best corrects the underlined portion?`,
        ...
        answer: 2,
        explanation: "The sentence implies the prom date was descending the stairs, but as written, 'Descending the stairs' modifies 'the young man'. Choice C ('As she descended the stairs') correctly shifts the subject of the descending to the prom date. Answer: C.",
        topic: "Dangling Modifier"
    },
    {
        id: 37,
...
Which choice best corrects the sentence?`,
        ...
        answer: 0,
        explanation: "The sentence is correct as written — 'Behind the rock' is a prepositional phrase that properly modifies the situation/location where the soldiers are sheltered. NO CHANGE. Answer: A.",
        topic: "Misplaced Modifier"
    },
    {
        id: 39,
...
Which choice best corrects the sentence?`,
        ...
        answer: 3,
        explanation: "'Walking out the door' must modify the shoppers, not the sunshine. Choice D places the shoppers as the subject immediately after the comma (as the ones who walked out the door). Answer: D.",
        topic: "Dangling Modifier"
    },
    {
        id: 40,
...
Which choice best corrects the sentence?`,
        ...
        answer: 2,
        explanation: "'Like his father before him' must modify the boy, not the army. Choice C places the boy as the subject immediately after the comma, making the comparison clear. Answer: C.",
        topic: "Dangling Modifier"
    },
    // ── Section 3: Misplaced Modifier (A–D, "This sentence is correct" type) ──
    {
        id: 41,
...
Which choice best rewrites this sentence to fix any modifier issue?`,
        ...
        answer: 0,
        explanation: "The phrase 'at the end of the meeting' is misplaced — it seems to modify 'his speech' (implying the speech was at the end), but it should modify when the trustees congratulated him. Choice A moves the phrase to the front to clarify the timing. Answer: A.",
        topic: "Misplaced Modifier"
    },
    {
        id: 42,
...
Which choice best rewrites this sentence to fix any modifier issue?`,
        ...
        answer: 3,
        explanation: "'Wagging her tail' correctly modifies the puppy — the puppy was wagging her tail as she climbed into my lap. The sentence is grammatically correct as written. Answer: D (This sentence is correct).",
        topic: "Misplaced Modifier"
    },
    {
        id: 43,
...
Which choice best rewrites this sentence to fix any modifier issue?`,
        ...
        answer: 0,
        explanation: "'Working on my computer' must modify 'I', but 'the power' is the subject — a dangling modifier. Choice A restructures using 'While I was working' to properly attach the action to the correct person. Answer: A.",
        topic: "Dangling Modifier"
    },
    {
        id: 44,
...
Which choice best rewrites this sentence to fix any modifier issue?`,
        ...
        answer: 0,
        explanation: "'When defrosted' dangles — it seems to modify 'you' rather than 'the meat'. Choice A clarifies that it is the meat that is defrosted. Answer: A.",
        topic: "Dangling Modifier"
    },
    {
        id: 45,
...
Which choice best rewrites this sentence to fix any modifier issue?`,
        ...
        answer: 2,
        explanation: "'That has meat' is a relative clause that should modify 'a meal', but it is currently placed after 'restaurant', making it seem like it describes the restaurant. Choice C moves 'that has meat' next to 'a meal' to fix the misplacement. Answer: C.",
        topic: "Misplaced Modifier"
    },
    {
        id: 46,
...
Which choice best rewrites this sentence to fix any modifier issue?`,
        ...
        answer: 2,
        explanation: "'On the radio' is misplaced — it seems to say the rain will happen on the radio. Choice C correctly moves 'on the radio' next to 'said' to clarify that the saying happened on the radio. Answer: C.",
        topic: "Misplaced Modifier"
    },
    {
        id: 47,
...
Which choice best rewrites this sentence to fix any modifier issue?`,
        ...
        answer: 3,
        explanation: "'Walking to my car' correctly modifies 'I' — I was walking to my car when I spilled tea on my suit. The sentence is correct as written. Answer: D (This sentence is correct).",
        topic: "Misplaced Modifier"
    },
    {
        id: 48,
...
Which choice best rewrites this sentence to fix any modifier issue?`,
        ...
        answer: 3,
        explanation: "'Late as always' correctly modifies Mike — he is the one who is characteristically late. The sentence is grammatically correct as written. Answer: D (This sentence is correct).",
        topic: "Misplaced Modifier"
    },
    {
        id: 49,
...
Which choice best rewrites this sentence to fix any modifier issue?`,
        ...
        answer: 1,
        explanation: "'While eating dinner' must modify 'she' (the person eating), not the fly. Choice B restructures the sentence using 'while she was eating' to correctly attach the modifier to the right subject. Answer: B.",
        topic: "Dangling Modifier"
    },
    {
        id: 50,
...
Which choice best rewrites this sentence to fix any modifier issue?`,
        ...
        answer: 3,
        explanation: "The sentence is correct as written — 'as I have trouble sleeping' is a causal clause correctly attached to 'the TV helps me get through the night'. There is no modifier error. Answer: D (This sentence is correct).",
        topic: "Misplaced Modifier"
    }
];
