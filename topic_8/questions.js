...
const QUESTIONS = [
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. The student wants to explain the causal mechanism — WHY fossil fuels contribute to climate change. Only option C links combustion → greenhouse gas release → temperature rise in a single logical chain.",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. The goal is to highlight a contrast in environmental impact. Option B directly juxtaposes the two: fossil fuels (harmful emissions) vs. renewables (little to no emissions).",
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. An introduction to a policy paragraph should mention both the problem (environmental damage from fossil fuels) and the policy response (government subsidies for renewables). Option C does both.",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. The notes cover: fossil fuel dependence → emissions → climate impact → government response → renewables as alternative. Option B accurately captures this cause-problem-solution arc.",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. A concluding sentence about urgency should synthesize the problem, the availability of solutions, and a strong call to action. Option B does all three while conveying urgency through \"not merely desirable — it is necessary.\"",
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. The student wants a practical implication for policy. Option C connects the data points (teen sleep deficit + evidence from later start times) and draws a policy conclusion — the exact goal.",
    "topic": "Identify Purpose & Goal"
  },
  {
    "id": 7,
    ...
    "answer": 2,
    "explanation": "Choice C is correct. The surprising finding in the notes is that too much sleep (>8 hours) is also harmful. Option C presents this unexpected result while framing it as counterintuitive — the ideal approach to surprise the reader.",
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. To argue there is a current problem specifically for teenagers, the sentence needs specific data (6.5 hours average) and the benchmark (7–8 hours optimal). Option C combines both to frame the gap as a problem.",
  ...
  },
  {
    ...
    "answer": 3,
    "explanation": "Choice D is correct. The question asks for evidence specifically that a policy change (later start times) produced measurable academic outcomes (GPA and attendance). Only the final note directly supports this.",
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. A strong thesis synthesizes the main points: sleep matters for cognition + teens are sleep-deprived + a specific policy response. Option C does all three concisely.",
    "topic": "Synthesis & Organization"
  },
  {
    "id": 11,
    ...
    "answer": 1,
    "explanation": "Choice B is correct. An introductory sentence for a general audience should define the term and give a sense of its scope. Option B defines bioluminescence clearly and mentions the range of species — ideal for an introduction.",
    "topic": "Identify Purpose & Goal"
  },
  {
    "id": 12,
    ...
    "answer": 1,
    "explanation": "Choice B is correct. The goal is to explain WHY deep-sea creatures rely on bioluminescence. Option B gives the reason directly: no sunlight below 200 meters, so bioluminescence is an adaptation to the dark environment.",
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. A symbiotic relationship benefits two organisms simultaneously — the bacteria provide light, the fish provide nutrients. This is the only note showing mutual benefit.",
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. The goal is to convey multiple distinct survival purposes. Option C lists four specific functions from the notes and explicitly frames the trait as versatile — directly matching the goal.",
    "topic": "Identify Purpose & Goal"
  },
  {
    "id": 15,
    ...
    "answer": 2,
    "explanation": "Choice C is correct. Options A, B, and D are all directly supported by specific notes. Option C — about humans engineering bioluminescent crops — appears nowhere in the notes and cannot be supported.",
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. A topic sentence for a paragraph on social and mental health benefits should introduce exactly those themes. Option C introduces both social (community bonds) and mental health (stress reduction) — the two themes the paragraph will cover.",
    "topic": "Synthesis & Organization"
  },
  {
    "id": 17,
    ...
    "answer": 1,
    "explanation": "Choice B is correct. The note about providing produce to those who \"lack access to grocery stores\" describes a food access problem. Option B introduces the concept of food deserts and directly connects urban gardening to solving that problem.",
    "topic": "Use Evidence for Argument"
  },
  {
    "id": 18,
    ...
    "answer": 2,
    "explanation": "Choice C is correct. The goal is to show city-wide benefits. Option C lists multiple types of benefits (environmental, social, nutritional) and explicitly extends them to \"the entire urban ecosystem and its residents\" — precisely matching the goal.",
    "topic": "Identify Purpose & Goal"
  },
  {
    "id": 19,
    ...
    "answer": 3,
    "explanation": "Choice D is correct. The notes mention stress reduction, social cohesion, heat absorption, and food access — but crime reduction is never mentioned. Option D makes a claim entirely unsupported by the notes.",
    "topic": "Unsupported Claim"
  },
  {
    "id": 20,
    ...
    "answer": 2,
    "explanation": "Choice C is correct. A synthesizing conclusion should touch on all major categories. Option C covers environmental (cooling temperatures), food access (underserved communities), social (neighborhood bonds), and mental health (reducing stress) — all four dimensions from the notes.",
    "topic": "Conclusion & Emphasis"
  },
  {
    "id": 21,
    ...
    "answer": 1,
    "explanation": "Choice B is correct. The goal is balance — one benefit and one risk. Option B names a clear benefit (efficiency and insights) and two concrete risks (job displacement and algorithmic bias) from the notes, presenting them as things to be \"weighed against\" each other.",
    "topic": "Contrast & Comparison"
  },
  {
    "id": 22,
    ...
    "answer": 1,
    "explanation": "Choice B is correct. A warning to policymakers needs to name the specific danger: biased training data → amplified bias → social harm. Option B traces this chain and specifically warns that unregulated deployment could entrench inequalities.",
    "topic": "Use Evidence for Argument"
  },
  {
    "id": 23,
    ...
    "answer": 3,
    "explanation": "Choice D is correct. A regulatory gap means regulation has not kept up with the technology. The note that \"regulatory frameworks are still in early stages in most countries\" directly identifies this gap.",
    "topic": "Evaluate Evidence"
  },
  {
    "id": 24,
    ...
    "answer": 1,
    "explanation": "Choice B is correct. A thesis for the argument that AI needs ethical safeguards should acknowledge benefits AND name specific risks that make safeguards necessary. Option B does exactly this: acknowledges benefits, names three specific risks, and calls for safeguards.",
    "topic": "Synthesis & Organization"
  },
  {
    "id": 25,
    ...
    "answer": 2,
    "explanation": "Choice C is correct. The conclusion must call for action based on what the notes actually support — not overstating or understating. Option C names risks from the notes (bias, displacement, regulatory gaps) and calls for proactive frameworks without making claims the notes do not support.",
    "topic": "Conclusion & Emphasis"
  }
];
