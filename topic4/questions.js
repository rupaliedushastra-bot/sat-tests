...
Which choice completes the text with the most logical and precise word?`,
    ...
    answer: 2,
    explanation: '"Emitted" means given off or released — exactly what light does. "Evicted" means removed from a place, "eliminated" means abolished, and "entrusted" means handed over for safekeeping. None of these fit the context of light being produced by bacteria.',
...
Which choice completes the text with the most logical and precise word?`,
    ...
    answer: 0,
    explanation: 'The context describes what happened after Thutmosis I — his elder son "according to Egyptian law" took over the position. "Succeeded" means to follow in a position or role, which fits a king being followed by his heir. "Evaluated" (assessed), "criticized" (found fault), and "neglected" (ignored) are all unrelated to royal succession.',
    topic: 'Vocabulary in Context'
  },
  {
    id: 6,
...
Which choice completes the text so that it conforms to the conventions of Standard English?`,
    ...
    answer: 1,
    explanation: 'The pronoun needed here is the subject of the verb — "who" (not "whom," which is an object pronoun). Additionally, the present perfect "have known" is correct because it refers to an experience that connects past and present. "Who knew" (D) uses the correct pronoun but the wrong tense — it implies a specific past moment rather than ongoing experience.',
...
Which choice completes the text so that it conforms to the conventions of Standard English?`,
    ...
    answer: 1,
    explanation: 'The subject is "the era," which is singular — so it requires the singular verb "advances." "Advance" is plural. "Have advanced" and "will have advanced" use plural helping verbs (have) and shift the tense unnecessarily. "Advances" correctly agrees with the singular subject "era."',
    topic: 'Standard English Conventions'
  },
  {
    id: 8,
...
Which choice completes the text with the most logical transition?`,
    ...
    answer: 0,
    explanation: '"Rather" signals a contrast and correction — "this is NOT X... Rather, it IS Y." The passage corrects a possible misconception (foreign-run lab) and replaces it with the truth (African-run center). "Therefore" and "Accordingly" imply consequence. "Furthermore" adds more of the same idea. Only "Rather" creates the corrective contrast the passage needs.',
    topic: 'Transitions'
  },
  {
    id: 11,
...
Which choice completes the text with the most logical transition?`,
    ...
    answer: 3,
    explanation: '"In fact" introduces a reinforcing statement — it strengthens and confirms the first claim by adding more evidence. The second half of the sentence is not a contrast to the first (ruling out "but," "nonetheless," and "conversely") — it elaborates and emphasizes the same point that breathing is essential.',
    topic: 'Transitions'
  },
  {
    id: 12,
...
Which choice completes the text with the most logical and precise word?`,
    ...
    answer: 3,
    explanation: 'The galaxy "resembles a hazy patch of passing cloud" — meaning it lacks a clear, sharp form. A galaxy WITHOUT a "defined" structure has no distinct shape. "Blurry" is what it looks like (not what it lacks). "Brittle" relates to physical fragility, and "heavy" relates to weight — neither is relevant to a galaxy\'s appearance.',
    topic: 'Vocabulary in Context'
  },
  {
    id: 15,
...
Which choice completes the text with the most logical and precise word?`,
    ...
    answer: 2,
    explanation: 'The passage explains that different bear behaviors require different human responses. If your response changes based on what the bear does, then the bear\'s behavior "determines" (causes or dictates) your response. "Ignore" contradicts the entire passage. "Mimic" would mean copying the bear. "Follow" would mean the bear\'s behavior comes after your response — the opposite of what the passage says.',
    topic: 'Vocabulary in Context'
  },
  {
    id: 16,
...
Which choice completes the text with the most logical and precise word?`,
    ...
    answer: 2,
    explanation: '"Alleviate" means to reduce or lessen — the policy provides assistance programs to make the financial burden smaller. "Increase" and "worsen" are the opposite of what assistance programs do. "Ignore" means to disregard, which contradicts actively providing programs to help.',
    topic: 'Vocabulary in Context'
  },
  {
    id: 17,
...
Which choice completes the text with the most logical and precise word?`,
    ...
    answer: 3,
    explanation: '"Scrutinize" means to examine closely and critically — exactly what "examining every clause for loopholes" describes. "Approve" and "reject" are final decisions, not the act of careful examination. "Implement" means to carry out, which is what happens after the review, not during it.',
    topic: 'Vocabulary in Context'
  },
  {
    id: 20,
...
Which choice completes the text with the most logical and precise word?`,
    ...
    answer: 1,
    explanation: '"Mitigate" means to lessen or reduce the severity of something — these efforts are aimed at making climate change effects less harmful. "Intensify" means to make worse, which is the opposite. "Ignore" and "accept" suggest inaction, which contradicts the list of specific actions provided.',
    topic: 'Vocabulary in Context'
  },
  {
    id: 21,
    ...
    answer: 2,
    explanation: 'A transition sentence must bridge two topics — here from benefits TO challenges. Option C does exactly this: it uses "however" to signal a shift and introduces "challenges" as the new direction. Options A, B, and D continue discussing benefits or general support, never pivoting to challenges.',
    topic: 'Transitions'
  },
  {
    id: 22,
