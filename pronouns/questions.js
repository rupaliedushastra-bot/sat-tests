...
const QUESTIONS = [
    // ── Section 1: Pronoun Clarity / Ambiguous Reference ──
    {
        id: 1,
        text: `The tree branch banged and rattled against the window all night, and in the morning, it was in pieces.

Which choice is correct?`,
        options: ["it was in pieces (NO CHANGE)", "it is", "it will be", "the window was"],
        answer: 3,
        explanation: "'It' is ambiguous — it could refer to the tree branch or the window. Replacing 'it' with 'the window was' clarifies which was in pieces. Answer: D.",
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "'Her' has no clear antecedent in the sentence — no female has been introduced. Replacing with 'a female student' eliminates the ambiguous pronoun. Answer: C.",
        topic: "Ambiguous Pronoun Reference"
    },
    {
        id: 3,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'Him' is ambiguous — it could refer to the President of France or the delegate from Spain. 'Promising both' clarifies that the promise was made to both parties. Answer: D.",
        topic: "Ambiguous Pronoun Reference"
    },
    {
        id: 4,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "'They' clearly refers to 'the chefs' introduced earlier, and 'it' refers to 'strawberry jam' (singular). The pronoun references are clear and correct. NO CHANGE. Answer: A.",
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'They' is ambiguous — it could refer to the dogs or the cats. 'The cats tend to chase the mice' eliminates the ambiguity and makes the sentence clear. Answer: D.",
        topic: "Ambiguous Pronoun Reference"
    },
    {
        id: 6,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "'It' is vague — referring to one of three subjects listed. Since the context implies a single subject is required, and 'math' is a common graduation requirement, 'but math is' clarifies the antecedent. Answer: B.",
        topic: "Ambiguous Pronoun Reference"
    },
    {
        id: 7,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "'They' refers back to a list of animals, which is confusing. The sentence implies a different animal was the favorite — since the original list didn't include an eagle, 'the eagle I saw was' introduces a clear new subject. Answer: C.",
        topic: "Ambiguous Pronoun Reference"
    },
    {
        id: 8,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "'Him' is ambiguous — it could mean the prince or King Richard. 'So they rallied to their king' makes it clear that the soldiers rushed to defend King Richard. Answer: C.",
        topic: "Ambiguous Pronoun Reference"
    },
    {
        id: 9,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "'They' clearly refers to 'my friends' and 'it' refers to 'the party'. Both pronoun references are unambiguous. NO CHANGE is correct. Answer: A.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 10,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "'It' is ambiguous — it could refer to China, Korea, or some unspecified place. 'Of the countries' clearly refers to both China and Korea without repeating their names unnecessarily. Answer: C.",
        topic: "Ambiguous Pronoun Reference"
    },
    {
        id: 11,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'Its' is ambiguous — it could refer to the ocean, the lake, or the kelp. 'A distinctive smell' removes the ambiguous pronoun entirely and makes the sentence clearer. Answer: D.",
        topic: "Ambiguous Pronoun Reference"
    },
    {
        id: 12,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'It' is ambiguous — it could refer to the piano or the sound. 'A trained pianist will find the sound especially beautiful' eliminates ambiguity by naming the specific referent. Answer: D.",
        topic: "Ambiguous Pronoun Reference"
    },
    {
        id: 13,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "'It' does not agree with the plural antecedent 'downloads'. 'They cannot be accurately traced' correctly uses the plural pronoun to match the plural antecedent. Answer: B.",
        topic: "Pronoun–Antecedent Agreement"
    },
    // ── Section 2: Pronoun–Antecedent & SVA Mix ──
    {
        id: 14,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "'No one' is an indefinite pronoun that is always singular and takes a singular verb. 'Was ready for' is correct. Answer: B.",
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "In American English, 'the company' is a singular collective noun and takes the singular pronoun 'it'. 'It is going to turn to investors' is correct. Answer: C.",
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'They' is ambiguous — it could refer to teachers or students. 'Such an instructor can often be found' clearly refers to the type of teacher described, eliminating the ambiguity. Answer: D.",
        topic: "Ambiguous Pronoun Reference"
    },
    {
        id: 17,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'Someone' is a singular indefinite pronoun. The correct singular pronoun is 'he or she'. Also, 'savant' (singular) agrees with the singular 'someone'. 'He or she can be called a savant' is correct. Answer: D.",
        topic: "Indefinite Pronouns"
    },
    {
        id: 18,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "'Everyone' is an indefinite pronoun that is always singular. The parenthetical 'including all my friends and relatives' does not change the subject. The singular verb 'is going' is required, with the comma after the parenthetical retained. Answer: B.",
        topic: "Indefinite Pronouns"
    },
    {
        id: 19,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "The antecedent of the pronoun is 'the pack of wolves'. Since wolves are multiple animals fleeing, and the context treats them as individual animals running, the plural 'they' is more logical and natural. Answer: B.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 20,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "The antecedent is 'some well-educated people' (plural). The pronoun must agree: 'they deserve' is correct. 'He or she' is singular and does not match 'people'. Answer: D.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 21,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "The antecedent is 'these alloys' (plural). The pronoun must be plural: 'they'. Also, the meaning is that the alloys will be used UNTIL they can be replaced, so 'Until they can be' is correct. Answer: C.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 22,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "'Anyone' is a singular indefinite pronoun and requires a singular verb. 'Performances is open-minded' correctly uses the singular verb to agree with 'anyone'. Answer: B.",
        topic: "Indefinite Pronouns"
    },
    {
        id: 23,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "The subject is 'the gifted few' (plural). 'Talents' is part of the prepositional phrase modifying 'few'. The plural verb 'are' is correct. NO CHANGE. Answer: A.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 24,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "The subject of the question is 'both of your sisters' (plural). The plural verb 'Are' is required. 'Are both of your sisters attending the dance?' is correct. Answer: B.",
        topic: "Pronoun–Antecedent Agreement"
    },
    // ── Section 3: Pronoun Case ──────────────────
    {
        id: 25,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "'She and I' are the subjects of the clause, so subject pronouns are needed. 'Me' and 'her' are object pronouns and cannot be subjects. Also, the present perfect 'have spent' is more consistent with the ongoing action described. Answer: B.",
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "'Raphael, Bill, and I' is the subject of the sentence. 'I' (subject pronoun) is needed, not 'me' (object pronoun). Also, 'weary' (adjective) correctly modifies 'travelers', not 'wearily' (adverb). Answer: C.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 27,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'Students' is the subject of the sentence. The pronoun modifying a subject noun must be in the subject case: 'We students' (not 'Us students'). Answer: D.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 28,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'My friends and her' are the objects of the verb 'asked'. Object pronouns are required in this position. 'Her' (object) is correct; 'she' (subject) is not. Answer: D.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 29,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "'My puppy and I' is the subject of the sentence. 'I' (subject pronoun) is correct. The conventional order also places the other person/noun first ('My puppy and I', not 'Me and my puppy'). NO CHANGE. Answer: A.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 30,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'My brother and she' are the subjects of 'may get married'. Subject pronouns are needed. 'She' (subject) is correct, not 'her' (object). Convention places the other noun before the pronoun: 'she and my brother' or 'my brother and she'. Answer: D.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 31,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "In formal English, after the linking verb 'is', a subject pronoun (predicate nominative) is used: 'This is she.' The object pronoun 'her' is incorrect here. 'She always responds this is she' is correct. Answer: B.",
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "'Such as he' uses an implied verb: 'such as he [is]'. After 'as' in this comparative structure, a subject pronoun is required. 'He' is correct. NO CHANGE. Answer: A.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 33,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "'He and she' are the compound subject requiring subject pronouns (both 'he' and 'she') and the plural verb 'make'. NO CHANGE is correct. Answer: A.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 34,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "'Xander and me' are objects of the verb 'chased', so 'me' (object pronoun) is correct, not 'I'. 'Her' clearly refers to Martha. NO CHANGE is correct. Answer: A.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 35,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'Wildcats' is a noun used in apposition to a pronoun that acts as the subject within a clause. The subject pronoun 'we' is needed: 'the way we Wildcats do'. Answer: D.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 36,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "'For' is a preposition and requires an object pronoun. 'They' is a subject pronoun and cannot be the object of a preposition. 'For them, an encore' uses the correct object pronoun. Answer: C.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    // ── Section 4: Noun Agreement ────────────────
    {
        id: 37,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "War of the Worlds is a single play (singular). 'Many radio listeners' (plural) believed that 'the play' (singular) was 'an actual broadcast' (singular). NO CHANGE is correct. Answer: A.",
        topic: "Noun Agreement"
    },
    {
        id: 39,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'Hippopotamuses' (plural) requires the plural appositive 'Africa's most feared animals' and the plural verb 'account'. Answer: D.",
        topic: "Noun Agreement"
    },
    {
        id: 40,
...
Which choice is correct?`,
    ...
    // ── Section 5: Pronoun–Antecedent Agreement Set ──
    {
        id: 41,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "'Each of the nine planets' takes 'their' because the planets are multiple. The true subject of 'there is/are' is '162 celestial bodies' (plural), so 'there are' is correct. Answer: B.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 42,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'The bank' is singular, so the pronoun must be singular 'its'. 'Many of its customers no longer visit the bank itself' is correct. Answer: D.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 43,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "'Those' is a pronoun referring to 'constitutions' (the constitutions of the Native Americans). The sentence is clear and grammatically correct as written. NO CHANGE. Answer: A.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 44,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "'The committee' is a singular collective noun in American English and takes the singular pronoun 'its'. 'He' correctly refers to the chairman (singular). Answer: B.",
        topic: "Collective Nouns & Pronouns"
    },
    // ── Section 6: Who/Whom & Pronoun Case Mix ──
    {
        id: 45,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "The pronoun is the subject of the clause 'who has the most stock' — subject pronouns use 'who', not 'whom'. Also, the verb must be singular 'has' to agree with the singular 'who'. Answer: D.",
        topic: "Who vs. Whom"
    },
    {
        id: 46,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "The subject is 'Anyone' (singular indefinite pronoun). The singular verb 'is required to sign' is correct. Answer: B.",
        topic: "Indefinite Pronouns"
    },
    {
        id: 47,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "'You and I' are the subjects (correct). 'She and John' are the objects of 'irritate', so the object pronoun 'her' is needed, not 'she'. 'You and I will not irritate John and her' is correct. Answer: C.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 48,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "In American English, 'the choir' is a singular collective noun. The singular pronoun 'it' is correct. 'As it moved through elaborate and challenging four-part harmonies' is correct. Answer: D.",
        topic: "Collective Nouns & Pronouns"
    },
    {
        id: 49,
...
Which choice is correct?`,
    ...
    // ── Section 7: Mixed Pronoun Problems ────────
    {
        id: 50,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "Reflexive pronouns like 'myself' should only be used when the subject and object refer to the same person, or for emphasis. Here, the object of 'by' should be 'me' (object pronoun), not 'myself'. 'Either by him or me' is correct. Answer: A.",
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "'For' is a preposition requiring an object pronoun. 'I' is a subject pronoun and cannot follow 'for'. 'For both me and the President' uses the correct object pronoun 'me'. The past tense 'said' is also correct. Answer: B.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 52,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'Of whom' — 'whom' is the object of the preposition 'of', so the object pronoun 'whom' is required (not 'who'). 'All of whom were interested in what political positions' is correct. Answer: D.",
        topic: "Who vs. Whom"
    },
    {
        id: 53,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "'To' is a preposition requiring object pronouns. Both 'him' and 'me' are object pronouns. Convention places the other person first: 'to me and him' or 'to him and me'. Answer: B.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 54,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "'Me and you' are the subjects of the sentence, so subject pronouns are required. 'You and I' is correct (convention: put the other person first). Answer: C.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 55,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "'She and I' are the subjects. Subject pronouns required: 'she' (not 'her') and 'I' (not 'me'). Convention: other person first — 'she and I'. Answer: B.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 56,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'You and I' are the compound subjects. Subject pronouns needed: 'I' (not 'me'). The plural verb 'have' agrees with the compound subject. Answer: D.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 58,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "Both pronouns are subjects. 'He' (subject) is needed, not 'him' (object). The plural verb 'have been' agrees with the compound subject 'she and he'. Answer: C.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 60,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "The publicist is speaking for himself — the subject ('he') and the object refer to the same person, making the reflexive 'himself' correct here. 'For both the organization and himself' is correct. Answer: A.",
        topic: "Reflexive Pronouns"
    },
    {
        id: 62,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "'Them' has no clear antecedent in the sentence — no specific group of people has been introduced. Replacing 'them' with 'people' (general) eliminates the vague pronoun. Answer: C.",
        topic: "Ambiguous Pronoun Reference"
    },
    {
        id: 66,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "'Him' is ambiguous — both John and Michael are male. Replacing 'him' with 'John' (or 'Michael') clarifies who was sided with. Answer: C.",
        topic: "Ambiguous Pronoun Reference"
    },
    {
        id: 67,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "He was so generous to others that he ignored himself — the subject and the ignored person are the same, so the reflexive 'himself' is correct. Answer: D.",
        topic: "Reflexive Pronouns"
    },
    // ── Section 8: Final Mixed Set ────────────────
    {
        id: 70,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "'Category' is singular, so 'this category' and 'its relation' (singular possessive) are correct. 'Those things' is more appropriate than 'these things' for things being referred to in the abstract. 'It's' (contraction for 'it is') is incorrect — 'its' (possessive) is needed. Answer: A.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 71,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "'Between' is a preposition requiring object pronouns. 'She' is a subject pronoun and incorrect after 'between'. 'Between her and the family trust' is correct. Choice A also correctly restructures the appositive. Answer: A.",
        topic: "Pronoun Case (Subject vs. Object)"
    },
    {
        id: 72,
...
Which choice is correct?`,
        ...
        answer: 1,
        explanation: "'The grocery chain' is singular, requiring the singular pronoun 'its'. 'The grocery chain was seeking to offer its clientele' is correct. Answer: B.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 73,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'All workers' is plural. The plural pronoun 'their' correctly agrees with the plural antecedent 'all workers'. Answer: D.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 74,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "With 'neither...nor', the verb and pronoun agree with the closer subject: 'the employees' (plural). 'Their objections' correctly uses the plural pronoun to agree with 'employees'. Answer: A.",
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "'Remarkable' (adjective) correctly modifies 'departure'. 'Those' refers to 'strategies' (plural), which is appropriate since a predecessor would have laid multiple strategies. 'From those laid' is correct. NO CHANGE. Answer: C.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 77,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "The antecedent is 'renewable resources' (plural). The plural pronoun 'they' is required. 'As they may reduce our dependence on foreign oil' is correct. Answer: C.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 78,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "'It' refers to 'going to sporting events' (the activity), treated as a singular concept. 'Most men' is the appropriate quantifier. NO CHANGE is correct. Answer: A.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 79,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'Anyone' is singular, so 'they' doesn't agree. 'Preparing a plan and sticking to it' avoids the pronoun–antecedent issue entirely and is also cleaner and more parallel. Answer: D.",
        topic: "Indefinite Pronouns"
    },
    {
        id: 80,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "'They' is a dangling modifier — the subject of 'finished' must match 'the worker' (singular). 'Just as he finished work for the day, the worker found his lost green helmet and made his way home happily' correctly uses 'he' to refer to the worker. Answer: A.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 81,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "'The basketball team' is a singular collective noun in American English, requiring the singular pronoun 'its'. 'Although the basketball team used its star players' is correct. Answer: C.",
        topic: "Collective Nouns & Pronouns"
    },
    {
        id: 82,
...
Which choice is correct?`,
        ...
        answer: 2,
        explanation: "The antecedent of the pronoun is 'Most books' (plural). The plural pronoun 'them' is required. Also, 'materials' (plural) takes the plural verb 'cause'. 'That cause them to decay' is correct. Answer: C.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 83,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "'The person' is singular. The singular pronoun 'his or her' is required (not 'their'). 'Who' (not 'that') is used for people. 'Has most significantly transformed' uses the present perfect correctly for an ongoing relevance. Answer: D.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 84,
...
Which choice is correct?`,
        ...
        answer: 0,
        explanation: "The antecedent is 'employees' (plural). The plural pronoun 'they' is required. Also, 'feel as if they are part of a team' is the idiomatically correct construction (not 'feels to be'). Answer: A.",
        topic: "Pronoun–Antecedent Agreement"
    },
    {
        id: 85,
...
Which choice is correct?`,
        ...
        answer: 3,
        explanation: "The subject is 'a person' (third person singular), but 'your' is second person. The pronoun must match: 'his or her life' agrees with the singular 'a person'. Answer: D.",
        topic: "Pronoun–Antecedent Agreement"
    }
];
