...
const QUESTIONS = [
  ...
  },
  {
    ...
    answer: 1,
    explanation: 'Text 1 states that quantum-level physics holds that thermodynamic processes "should be reversible," yet Text 2 reports an experiment that found irreversibility at the quantum level—directly contradicting that expectation. The author of Text 1 would therefore likely view this as empirical evidence that the current understanding of microscopic-level physics (which predicts reversibility) is incomplete. A reverses the relationship (the macroscopic understanding, not the microscopic one, is consistent with the result); C and D introduce ideas (lab-vs-universe scope, researcher disagreement about significance) not supported by either text.',
    topic: 'Set 1 – Cross-Text Connections'
  },
  {
    id: 6,
  ...
  },
  {
    ...
    answer: 0,
    explanation: 'As with the earlier version of this question, Text 1 treats the findings as an unqualified "clear win," while Text 2 acknowledges the findings are encouraging but raises a caution about food supply impacts and calls for additional policy measures. The core difference is optimism versus caution. B, C, and D each introduce distinctions (disputed percentage, differing focus areas, differing timelines) that the texts do not actually support.',
    topic: 'Set 2 – Cross-Text Connections'
  },
  {
    id: 12,
  ...
  // ── SET 3: Multi-Passage Comparative Analysis (17 Qs) ─────────
  {
    id: 15,
