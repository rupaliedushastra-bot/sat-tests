...
const QUESTIONS = [
  {
    ...
    "answer": 3,
    "explanation": "Choice D is correct. Substitute x = 4 into the function: f(4) = 2(4) + 3 = 8 + 3 = 11. A) Incorrect; arbitrary value not related to the calculation. B) Incorrect; forgets to add 3. C) Incorrect; arithmetic error.",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. Substitute x = 4 into the equation: y = 2(4)² − 3 = 2(16) − 3 = 32 − 3 = 29. A) Incorrect; error in multiplication. C) Incorrect; mistake in subtraction step. D) Incorrect; unrelated calculation error.",
    "topic": "Function Evaluation"
  },
  {
    "id": 5,
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. In a linear model y = mx + b, the slope m represents the rate of change: for every increase of 1 in x, y increases by m. Here m = 2, so y increases by 2 for every unit increase in x. B) Incorrect; the slope is positive, not negative. C) Incorrect; this describes the y-intercept, not the slope. D) Incorrect; this is unrelated to the slope value.",
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. Set the two expressions for y equal to each other: 2x + 3 = 4x − 1. Subtract 2x from both sides: 3 = 2x − 1. Add 1 to both sides: 4 = 2x. Divide by 2: x = 2. A) Incorrect; error in solving for x. B) Incorrect; misunderstanding algebraic steps. D) Incorrect; incorrect subtraction.",
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. Set the two expressions for y equal to each other: 2x + 1 = −x + 4. Add x to both sides: 3x + 1 = 4. Subtract 1 from both sides: 3x = 3. Divide by 3: x = 1. B) Incorrect; wrong steps in isolating x. C) Incorrect; misunderstanding addition or subtraction. D) Incorrect; error in calculation.",
    "topic": "Intersection of Two Lines"
  },
  {
    "id": 14,
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. The domain of a function is defined as the set of all possible input values (x-values) for which the function is defined. A) Incorrect; this describes the range, not the domain. C) Incorrect; the slope is unrelated to the domain. D) Incorrect; the y-intercept is a single point, not the domain.",
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. The range of a function is the set of all possible output values (y-values) that the function can produce. A) Incorrect; this describes the domain, not the range. B) Incorrect; this is not a standard definition of range. D) Incorrect; this describes the y-intercept.",
    "topic": "Domain and Range"
  },
  {
    "id": 17,
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. Quadratic functions of the form y = ax² + bx + c produce parabolic (U-shaped) graphs. A) Incorrect; straight lines come from linear functions. C) Incorrect; circles are not graphs of quadratic functions in this form. D) Incorrect; a horizontal line corresponds to a constant function, not a quadratic.",
    "topic": "Types of Functions"
  },
  {
    "id": 19,
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. Subtract 3x from both sides: 2x − 7 = 5. Add 7 to both sides: 2x = 12. Divide by 2: x = 4. A) Incorrect; error in subtraction or division. B) Incorrect; mistake in algebraic manipulation. D) Incorrect; misunderstanding the equation-solving process.",
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. Subtract 3y from both sides: −2 = y + 1. Subtract 1 from both sides: −3 = y. B) Incorrect; misunderstanding subtraction. C) Incorrect; error in isolating y. D) Incorrect; incorrect calculation.",
    "topic": "Linear Equations"
  },
  {
    "id": 23,
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. Add 3 to both sides: 2x > 4. Divide both sides by 2: x > 2. This means the line y = 2x − 3 lies above the x-axis (y > 0) for all x > 2. B), C), D) Incorrect; these result from arithmetic errors when solving the inequality.",
