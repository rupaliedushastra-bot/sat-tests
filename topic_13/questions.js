// =============================================
// Digital SAT – Topic Test: Geometry
...
// Several questions include diagrams (triangles, circles, rectangles, solids)
// =============================================
...
const QUESTIONS = [
  {
    ...
    options: ['6', '7', '8', '9'],
    answer: 0,
    explanation: 'This is a right triangle (3-4-5), with the legs of lengths 3 and 4 acting as the base and height. Area = (1/2) × base × height = (1/2) × 3 × 4 = 6. B), C), D) Incorrect; calculation errors in applying the area formula.',
    topic: 'Triangle Area'
  },
  {
    id: 2,
    ...
    options: ['26', '30', '34', '40'],
    answer: 0,
    explanation: 'The perimeter of a rectangle is given by 2 × (length + width) = 2 × (8 + 5) = 2 × 13 = 26. B) Incorrect; doubles only the length. C) Incorrect; addition error. D) Incorrect; multiplies the length and width instead of adding them.',
  ...
  },
  {
    ...
    options: ['25 square units', '30 square units', '35 square units', '40 square units'],
    answer: 0,
  ...
  },
  {
    ...
    options: ['9 cubic units', '18 cubic units', '27 cubic units', '36 cubic units'],
    answer: 2,
  ...
  },
  {
    ...
    options: ['2', '3', '4', '5'],
    answer: 2,
    explanation: 'The volume of a cube is given by side³. Setting side³ = 64 and taking the cube root of both sides gives side = 4 (since 4³ = 64). A) Incorrect; misunderstanding the cube root. B) Incorrect; incorrect cube root calculation. D) Incorrect; arbitrary value not related to the calculation.',
    topic: 'Cube Volume'
  },
  {
    id: 12,
    ...
    options: ['2', '3', '4', '5'],
    answer: 2,
    explanation: 'Use the area formula Area = length × width: 24 = 6 × width. Dividing both sides by 6 gives width = 4. A) Incorrect; misunderstanding the division process. B) Incorrect; incorrect division. D) Incorrect; arithmetic error.',
    topic: 'Rectangle Area'
  },
  {
    id: 13,
    ...
    answer: 1,
    explanation: 'The sum of the interior angles in any triangle is always 180°. A) Incorrect; this is the measure of a right angle. C) Incorrect; misunderstanding the sum of angles in a polygon. D) Incorrect; this is the sum of angles in a circle (or a quadrilateral).',
  ...
  },
  {
    ...
    options: ['5', '6', '7', '8'],
    answer: 0,
    explanation: 'Use the Pythagorean theorem: a² + b² = c². Substituting a = 3 and b = 4: 3² + 4² = c², so 9 + 16 = c², giving c² = 25. Taking the square root gives c = 5. B), C), D) Incorrect; do not satisfy the Pythagorean theorem with legs of 3 and 4.',
  ...
  },
  {
    ...
    options: ['6', '7', '8', '9'],
    answer: 1,
    explanation: 'The area of a square is given by side². Setting side² = 49 and taking the square root of both sides gives side = 7 (since 7² = 49). A), C), D) Incorrect; do not satisfy side² = 49.',
    topic: 'Square Area'
  },
  {
    id: 16,
    ...
    answer: 2,
    explanation: 'The perimeter of a rectangle is given by 2(length + width) = 2(8 + 6) = 2 × 14 = 28 units. A) Incorrect; misunderstanding the perimeter formula (this is just the sum of length and width). B) Incorrect; incorrect multiplication. D) Incorrect; multiplies the length and width instead of finding the perimeter.',
    topic: 'Rectangle Perimeter'
  },
  {
    id: 17,
    ...
    options: ['6', '8', '10', '12'],
    answer: 0,
    explanation: 'The area A of a rectangle is given by A = length × width. Therefore: 24 = length × 4. Dividing both sides by 4 gives length = 6. B), C), D) Incorrect; arithmetic errors when dividing 24 by 4.',
    topic: 'Rectangle Area'
  },
  {
    id: 18,
  ...
  },
  {
    ...
    options: ['30°', '45°', '60°', '90°'],
    answer: 2,
    explanation: 'Since the sum of the angles in a triangle is always 180°, the third angle is 180° − 90° − 30° = 60°. A) Incorrect; this is the value of the given angle, not the missing one. B) Incorrect; does not result from 180° − 90° − 30°. D) Incorrect; this is the measure of the right angle that is already given.',
    topic: 'Triangle Angle Sum'
  },
  {
    id: 20,
    ...
    options: ['12π cubic units', '24π cubic units', '36π cubic units', '48π cubic units'],
    answer: 2,
    explanation: 'The volume V of a cylinder is given by V = πr²h. Therefore: V = π × 3² × 4 = π × 9 × 4 = 36π cubic units. A) Incorrect; misunderstanding the formula. B) Incorrect; error in squaring the radius. D) Incorrect; arithmetic error in multiplication.',
  ...
  },
  {
    ...
    options: ['9', '10', '11', '12'],
    answer: 3,
    explanation: 'The perimeter of a triangle is the sum of the lengths of its sides: 3 + 4 + 5 = 12. A) Incorrect; misunderstanding of perimeter calculation. B) Incorrect; adding only two of the three sides. C) Incorrect; arithmetic error in addition.',
  ...
  },
  {
    ...
    options: ['7', '8', '9', '10'],
    answer: 2,
    explanation: 'The area of a square is given by side². Setting side² = 81 and taking the square root of both sides gives side = 9 (since 9² = 81). A), B), D) Incorrect; misunderstanding or incorrect calculation of the square root.',
    topic: 'Square Area'
  },
  {
    id: 25,
    ...
    options: ['3', '4', '5', '6'],
    answer: 3,
    explanation: 'The area A of a triangle is given by A = (1/2) × base × height. Substituting A = 24 and base = 8: 24 = (1/2) × 8 × height, so 24 = 4 × height. Dividing both sides by 4 gives height = 6. A), B), C) Incorrect; arithmetic errors when solving for the height.',
    topic: 'Triangle Area'
  }
];
