...
const QUESTIONS = [
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. The area of a circle is given by A = πr². Setting πr² = 16π and dividing both sides by π gives r² = 16. Taking the square root gives r = 4. A) Incorrect; misunderstanding the area formula. B) Incorrect; wrong square root. D) Incorrect; overestimating the radius.",
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. The area of a circle is given by A = πr². Setting πr² = 25π and dividing both sides by π gives r² = 25. Taking the square root gives r = 5. B), C), D) Incorrect; arithmetic errors in solving for r, such as forgetting to take the square root.",
    "topic": "Circle Area & Radius"
  },
  {
    "id": 5,
    ...
    "answer": 0,
    "explanation": "Choice A is correct. The area of a triangle is given by A = (1/2) × base × height = (1/2) × 10 × 5 = 25 square units. B) Incorrect; misunderstanding the formula. C) Incorrect; incorrect multiplication. D) Incorrect; error in calculation (e.g., forgetting the 1/2 factor).",
    "topic": "Triangle Area"
  },
  {
    "id": 6,
    ...
    "answer": 2,
    "explanation": "Choice C is correct. The volume of a cube is given by V = s³. Substituting s = 3 gives V = 3³ = 27 cubic units. A) Incorrect; squares the side instead of cubing it. B) Incorrect; incorrect multiplication. D) Incorrect; misunderstanding the formula.",
    "topic": "Cube Volume"
  },
  {
    "id": 7,
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. The perimeter of a square is given by 4 × side length. Setting 4 × side length = 20 and dividing by 4 gives side length = 5. A) Incorrect; misunderstanding the perimeter formula. C), D) Incorrect; results from incorrect division.",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. The area of a rectangle is given by Area = length × width. Setting 24 = 8 × width and dividing both sides by 8 gives width = 3. A) Incorrect; results from incorrect division. C), D) Incorrect; arithmetic errors when dividing 24 by 8.",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. Substitute r = 5 into the formula: Circumference = 2π(5) = 10π. A) Incorrect; incorrect multiplication. C) Incorrect; misunderstanding the formula. D) Incorrect; arbitrary value not related to the calculation.",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. The perimeter P of a square is given by P = 4 × side length. Therefore: 20 = 4 × side length. Dividing both sides by 4 gives side length = 5. A) Incorrect; miscalculation in dividing by 4. C), D) Incorrect; errors in understanding the perimeter formula.",
    "topic": "Square Perimeter"
  },
  {
    "id": 19,
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. The circumference of a circle is given by C = 2πr. Substituting r = 7: C = 2π(7) = 14π. B) Incorrect; incorrect multiplication. C), D) Incorrect; confuse the circumference formula with the area formula or apply incorrect arithmetic.",
    "topic": "Circle Circumference"
  },
  {
    "id": 23,
    ...
    "answer": 0,
    "explanation": "Choice A is correct. The circumference of a circle is given by C = 2πr. Substituting r = 5: C = 2π(5) = 10π. B), C) Incorrect; arithmetic errors in multiplying 2 and 5. D) Incorrect; this would be the area formula result (πr²) rather than the circumference.",
    "topic": "Circle Circumference"
  },
  {
    "id": 24,
