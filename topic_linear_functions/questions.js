...
const QUESTIONS = [
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. Subtract 3x from both sides: ( 2x - 2 = 4 ). Add 2 to both sides: ( 2( x = 6 ) ). Divide by 2: ( x = 3 ). A) Incorrect; error in subtraction step. B) Incorrect; mistake in addition. D) Incorrect; misstep in solving.",
    "topic": "Linear Equations"
  },
  {
    "id": 5,
  ...
  },
  {
    ...
    "answer": 3,
    "explanation": "Choice D is correct. Distribute 4: ( 4x - 8 = 12 ). Add 8 to both sides: 4( x = 2 )0. Divide by 4: ( x = 5 ). A) Incorrect; miscalculation in distribution. B) Incorrect; mistake in addition. C) Incorrect; misunderstanding in division.",
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. Distribute the 3: ( 6x - 3 = 18 ). Add 3 to both sides: 6( x = 2 )1. Divide by 6: ( x = 2 )1/6 = 3.5. A) Incorrect; mistake in distributing. B) Incorrect; error in adding step. D) Incorrect; misunderstanding division.",
    "topic": "Linear Equations with Distribution"
  },
  {
    "id": 9,
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. Use the distributive property: ( 2(x + 5) ) = 2·x + 2·5 = ( 2( x + 10 ) ). B) Incorrect; fails to distribute to both terms. C) Incorrect; multiplies the wrong terms. D) Incorrect; only partially distributes the terms.",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. Add 7 to both sides: 3( x = 9 ). Divide by 3: ( x = 3 ). A) Incorrect; arithmetic error. C) Incorrect; arithmetic error. D) Incorrect; arbitrary value.",
    "topic": "Linear Equations"
  },
  {
    "id": 16,
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. Add the equations: (x + y) + (x − y) = 5 + 1, so ( 2( x = 6 ) ), giving ( x = 3 ). Substitute into x + y = 5 to get y = 2. A), C), D) Incorrect; do not satisfy both equations.",
    "topic": "Systems of Linear Equations"
  },
  {
    "id": 20,
