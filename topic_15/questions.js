// =============================================
// Digital SAT – Topic Test: Statistics & Probability
// 25 Questions | Single Timed Module (35 min)
// answers: 0=A, 1=B, 2=C, 3=D
// Covers mean, median, mode, range, standard deviation,
// probability, scatterplots, two-way tables, and data displays
...
const QUESTIONS = [
  ...
  },
  {
    ...
    options: ['4', '5', '8', '9'],
    answer: 1,
    explanation: 'To find the median, first arrange the values in order: 1, 4, 5, 8, 9. Since there are 5 values (an odd number), the median is the middle value, which is 5. A) Incorrect; this is the second value in the ordered list, not the middle. C), D) Incorrect; these are values to the right of the middle, not the median.',
    topic: 'Median'
  },
  {
    id: 3,
    text: `What is the median of the data set: 3, 7, 9, 12, 18, 20?`,
    options: ['9', '10.5', '12', '15'],
    answer: 1,
  ...
  },
  {
    ...
    options: ['2', '4', '6', '8'],
    answer: 1,
    explanation: 'The mode is the value that appears most frequently in the data set. The value 4 appears three times, more than any other value, so the mode is 4. A), C), D) Incorrect; each of these values appears only once in the data set.',
    topic: 'Mode'
  },
  {
    id: 5,
    ...
    answer: 2,
    explanation: 'The median is the middle value of a data set when arranged in order from least to greatest, dividing the data into two equal halves. A) Incorrect; this describes the mean, not the median. B) Incorrect; this describes the mode. D) Incorrect; this describes the range.',
  ...
  },
  {
    ...
    answer: 0,
    explanation: 'The mean is calculated using the sum of all values, so a single extremely large or small value (an outlier) can significantly shift the mean. B) Incorrect; the median depends only on the position of values, not their exact magnitude, so it is resistant to outliers. C) Incorrect; the mode depends on frequency, not magnitude, so it is generally unaffected by a single outlier. D) Incorrect; the range is a measure of spread, not central tendency, though it is also affected by outliers — but the question specifically asks about central tendency.',
  ...
  },
  {
    ...
    answer: 1,
    explanation: 'The mode is the category with the highest frequency. According to the bar chart, "Blue" has the tallest bar (7 students), more than any other color, making it the mode. A), C), D) Incorrect; these colors have lower frequencies than "Blue" according to the chart.',
  ...
  },
  {
    ...
    options: ['18/50', '20/50', '20/25', '38/50'],
    answer: 1,
  ...
  },
  {
    ...
    options: ['4/10 × 4/10', '4/10 × 3/9', '4/10 × 4/9', '6/10 × 5/9'],
    answer: 1,
  ...
  },
  {
    ...
    options: ['3', '8', '12', '5'],
    answer: 2,
    explanation: 'According to the histogram, the bar corresponding to the score range 80-89 has a height of 12, indicating that 12 students scored in this range. A), B), D) Incorrect; these values correspond to the heights of the other bars (60-69, 70-79, and 90-99 respectively), not the 80-89 range.',
    topic: 'Histograms'
  },
  {
    id: 23,
