...
const QUESTIONS = [
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. The mean is the sum of all values divided by the number of values: (2+3+3+5+7+7+7+9)/8 = 43/8 = 5.375. A) Incorrect; this would be the median, not the mean. C) Incorrect; rounds incorrectly. D) Incorrect; this is the mode, not the mean.",
    "topic": "Mean"
  },
  {
    "id": 2,
  ...
  },
  {
    ...
    "answer": 3,
    "explanation": "Choice D is correct. The probability of spinning a 2 is 1/4 (one favorable outcome out of four equally likely sections). The probability of NOT spinning a 2 is the complement: 1 − 1/4 = 3/4. A) Incorrect; this is the probability of spinning a 2, not the complement. B), C) Incorrect; do not correctly apply the complement rule for this scenario.",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. The even numbers on the spinner are 2 and 4, which is 2 out of 4 equally likely sections. The probability is 2/4 = 1/2. A) Incorrect; this would be the probability of landing on a single specific number. C), D) Incorrect; overestimates the proportion of even-numbered sections.",
    "topic": "Basic Probability"
  },
  {
    "id": 19,
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. Since 120 out of 200 people prefer coffee, the remaining 200 − 120 = 80 people prefer tea. The probability of selecting someone who prefers tea is 80/200 = 2/5. B) Incorrect; this is the probability of selecting someone who prefers coffee (120/200 = 3/5), not tea. C) Incorrect; does not correctly represent the proportion of tea drinkers. D) Incorrect; this equals 3/5, the same as the probability for coffee, not tea.",
