// =============================================
// Digital SAT Practice - Topic: topic_words_in_context
// 25 Questions
// =============================================
...
const QUESTIONS = [
  {
    "id": 1,
    "text": "While life is a special\nof complex\nchemistry, the elements involved are nothing\nspecial: carbon, hydrogen, oxygen, etc., are among\nthe most abundant elements in the universe.\nComplex organic chemistry is surprisingly\ncommon. Amino acids, just like those that make\nup every protein in our bodies, have been found\nin the tails of comets. There are other organic\ncompounds in Martian soil. And 6.500 light years\naway, a giant cloud of space alcohol floats among\nthe stars.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "model",
      "kind",
      "unit",
  ...
  {
    "id": 3,
    "text": "Behavioral activation is a type of talk therapy\nthat helps teens get unstuck from negative mood\nspirals by noticing a\nbetween what they\ndo and how they feel, and gradually adding\nmore small and enjoyable actions back into life.\nBehavioral activation has the goal of decreasing\navoidance, bolstering peer connection, and\nimproving engagement in rewarding activities.\nIt also incorporates parent involvement so\nparents gain tools for supporting their adolescent\nchildren.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "relevance",
      "bond",
      "correspondence",
  ...
  {
    "id": 4,
    "text": "Ihe researchers found that variance among\nthe sites did not increase over the millennia,\nleading them to conclude that stabilizing forces\nwere maintaining forest diversity. \"Our findings\nindicate there are factors that\npopulations\nat relative abundances that are consistent from\none place to another,\" said scientist James Clark.\n\"Our study doesn't identify what those stabilizing\nforces are, however.\"\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "supervise",
      "manage",
      "balance",
  ...
  {
    "id": 5,
    "text": "Mann's research was conducted in two parts - a\nliterature review and interview study. A literature\nreview of both the scientific and the popular\nliterature was conducted and reviewed from\nAugust to November, 2013. The interview study\ninvolved semi-structured, one-time, in-person\nprivate interviews conducted the same year.\nTwenty vegans were interviewed, and questions\ntargeted personal history of veganism, related\nhealth beliefs, factors influencing the decision to\nbecome vegan, and diet\n. Once all data was\nobtained, it was analyzed in tandem.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "arrangement",
      "disposition",
      "constitution",
  ...
  {
    "id": 6,
    "text": "The following text is adapted from Abraham\nLincollfi last public address, given April 11, 1965.\nTo the Blacks we say, \"This cup of liberty\nwhich these, your old masters. hold to\nyour lips, we will dash from you, and leave\nyou to the chances of gathering the spilled\nand scattered contents in some vague and\nundefined when, where, and how.\" If this\ncourse, discouraging and paralyzing both\nwhite and black, has any tendency to bring\nLouisiana into proper practical relations\nwith the Union, I have, so far, been unable to\nperceive it. If, on the contrary, we\nand sustain the new government of Louisiana,\nthe converse of all this is made true.\nAs it is used in the text, what does the word\n\"recognize\" most nearly mean?",
    "options": [
      "identify",
      "accept",
      "realize",
  ...
  {
    "id": 7,
    "text": "HEPHLI belongs to a family of proteins known\nas multicopper oxidases (MCOs). One unique\nproperty of MCOs is the presence of three\ncopper-binding sites that can\nsix copper\natoms. Mutations that alter the structure of these\nsites are likely to affect their ability to bind copper.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "house",
      "quarter",
      "lodge",
  ...
  {
    "id": 9,
    "text": "It was an audacious idea: To send an unmanned\nresearch vehicle called a saildrone on a 13.670-\nmile journey around Antarctica alone, at the\nmercy of the most hostile seas on the planet. In\nwinter. \"The assumption was the Southern Ocean\nwould eat the saildrone.. .and that would be that,\"\nsaid NOAA oceanographer Adrienne Sutton. \"But\nwe were willing to try, given the large role the\nocean plays in the trajectory of climate change.\"\nAs used in the text, what does the word \"hostile\"\nmost nearly mean?",
    "options": [
      "aggressive",
      "antagonistic",
      "unforgiving",
  ...
  {
    "id": 10,
    "text": "Demographic, transportation, and environmental\nchanges will drive employment growth for\nplanners. Within cities, urban planners will be\nneeded to develop revitalization projects and\nissues associated with population growth,\nenvironmental degradation, the movement of\npeople and goods, and resource scarcity.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "remit",
      "address",
      "communicate",
  ...
  {
    "id": 11,
    "text": "Behavioral activation is a type of talk therapy\nthat helps teens get unstuck from negative mood\nspirals by noticing a\nbetween what they\ndo and how they feel, and gradually adding more\nsmall and enjoyable actions back into their lives.\nBehavior activation has the goal of decreasing\navoidance, bolstering peer connection, and\nimproving engagement in rewarding activities. It\nalso incorporates parental involvement so parents\nlearn tools for supporting their adolescents.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "relevance",
      "bond",
      "correspondence",
  ...
  {
    "id": 12,
    "text": "We need to look for robust biospheres\n(atmospheres. surfaces, and/or oceans) capable\nof creating planet-scale change in order to find\nlife on other planets. Presently, Earth is the\nonly body in our solar system with a biosphere\ndetectable by its light spectrum, despite the\npossibility that habitable conditions might\nin the subsurface of Mars or inside the icy moons\nof the outer solar system. Even if life exists on\nthese worlds, it is very unlikely that it could yield\nplanet-scale changes that are both telescopically\nobservable and clearly biological in origin.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "exist",
      "triumph",
      "overcome",
  ...
  {
    "id": 13,
    "text": "Ihe researchers found that variance among the\ntest sites did not increase over the millennia,\nleading them to conclude that stabilizing forces\nwere maintaining forest diversity.\n-our findings indicate there are factors that\npopulations at relative abundances that are\nconsistent from one place to another,\" said Clark.\n-The variation from place to place is not \u0007neutral.'\nEcologists have long known that, within a region,\nsome species tend to be more abundant and some\nspecies less abundant. Our study doesn't identify\nwhat those stabilizing forces are, but it clearly\nshows they do not arise from neutral dynamics.\"\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "supervise",
      "oversee",
      "regulate",
  ...
  {
    "id": 14,
    "text": "Although an antibody-based overdose drug\nwould be more expensive than standard\ntreatments, the authors say, it would cost less than\ncancer immunotherapy, which is now routinely\nused to treat patients. In the coming weeks, the\nteam will test the antibodies' ability to\nsynthetic opioids' effects in nonhuman primates.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "rebuff",
      "dismay",
      "contradict",
  ...
  {
    "id": 15,
    "text": "The nature of the interviews conducted for this\npaper was such that a comprehensive but diverse\ncollection of information was obtained. precisely\nbecause the interviewees have chosen the vegan\ndiet for a multitude of reasons, and approach their\ndiet and lifestyle in varied ways. However. there\nare some commonalities that were\nwhen\nwe analyzed the data carefully.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "uncovered",
      "betrayed",
      "confessed",
  ...
  {
    "id": 16,
    "text": "Black bears in North Carolina have adapted\nto city life so well that their behavioral and\nbiological habits are changing. They are unafraid\nto forage during the daytime, and many residents\nplace food outside to entice the bears closer for\neasy viewing. Resulting conflicts have led the city\nof Asheville to create laws that\nfeeding\nbears.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "denigrate",
      "embargo",
      "prohibit",
  ...
  {
    "id": 17,
    "text": "In Timbulsloko, Indonesia, the rice crops failed\nin the 1990s because the land was sinking and\nthe saline ocean water entered the rice paddies.\nResidents changed to raising milkfish and tiger\nprawns in the brackish pond water. However, they\ncan no longer survive on aquaculture because the\nand the region is now\nocean continues to\nabout one mile away from the mainland area.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "encroach",
      "conquer",
      "vanquish",
  ...
  {
    "id": 18,
    "text": "Ihe following text is adapted from Robert Louis\nStevenson's 1882 novel, Treasure Island.\nWell, mother was upstairs with father and\nI was laying the breakfast-table against\nthe captain's return when the parlour door\nopened and a man stepped in on whom I\nhad never set my eyes before. He was a pale,\ntallowy creature, wanting two fingers of the\nleft hand, and though he wore a cutlass, he did\nnot look much like a fighter. I had always my\neye open for seafaring men, with one leg or\ntwo, and I remember this one puzzled me. He\nwas not sailorly, and yet he had a smack of the\nsea about him too.\nAs used in the text, what does the word \"wanting\"\nmost nearly mean?",
    "options": [
      "craving",
      "lacking",
      "requiring",
  ...
  {
    "id": 19,
    "text": "Honing knives on a stone wheel is becoming a\nlost art, but craftsmen who still use that method\ncan tell the percentage of carbon in a blade based\non the color and number of sparks that fly\nthe instant the metal touches the wheel.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "evolved",
      "manufactured",
      "generated",
  ...
  {
    "id": 20,
    "text": "Known as the Abominable Snowman in Western\nCulture, the Yeti is a giant, mythological, ape-like\ncreature that has its basis in sherpa tales from\nthe Himalayan Mountains. Many people have\nreported seeing the creature, and some even offer\nblurry videos, damaged photographs, and other\nevidence to support their vague claims.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "coherent",
      "hesitant",
      "dubious",
  ...
  {
    "id": 21,
    "text": "Recent research has determined that rattlesnakes\ncan alter the rate of vibrations in their tail\nto produce sounds that make them appear\ncloser than they really are to a creature that is\napproaching. Ihis cunning manipulation of\nsound, similar to the way an ambulance siren\nseems to increase in pitch as it comes closer, is\none attempt to scare off\npredators.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "preventative",
      "pretentious",
      "prosperous",
  ...
  {
    "id": 22,
    "text": "Over the past three decades, scientists have\nrevealed emotional responses such as grief\nand play in a surprising array of animal and\neven insect species. However, researchers who\nstudy emotions in animals are often accused of\nanthropomorphizing their\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "questions",
      "volunteers",
      "subjects",
  ...
  {
    "id": 23,
    "text": "NASAs Artemis I mission will feature a\nCampos to record such\nmannequin\ninformation as seat vibrations, gravity, and\nradiation as part of the preparations for another\nmanned mission to the Moon.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "entitled",
      "granted",
      "dubbed",
  ...
  {
    "id": 24,
    "text": "Ihe Leaning Tower of Pisa is known for its\nprecarious-looking 4-degree tilt, which started to\nduring construction in the twelfth century\nbecause the soft ground was unable to support the\nmassive weight of the structure.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "initiate",
      "confirm",
      "evince",
  ...
  {
    "id": 25,
    "text": "Alexander Calder ( 1898- 1976) was a sculptor\nand inventor who is best known for his mobiles,\nwhich are kinetic sculptures that employ either\nmotors or wind currents to add a level of\nto\nthe arrangement of the parts at any given time.\nWhich choice completes the text with the most\nlogical and precise word or phrase?",
    "options": [
      "prosperity",
      "serendipity",
      "accountability",
