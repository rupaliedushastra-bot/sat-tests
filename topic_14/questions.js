...
const QUESTIONS = [
  {
    ...
    answer: 0,
    explanation: 'By definition, sine is the ratio of the opposite side to the hypotenuse (SOH): sin(θ) = opposite/hypotenuse = 3/5. B) Incorrect; this is cos(θ) = adjacent/hypotenuse. C) Incorrect; this is tan(θ) = opposite/adjacent. D) Incorrect; this is the reciprocal of tan(θ).',
  ...
  },
  {
    ...
    answer: 1,
    explanation: 'By definition, cosine is the ratio of the adjacent side to the hypotenuse (CAH). Since θ is opposite the side of length 5, the adjacent side has length 12, so cos(θ) = 12/13. A) Incorrect; this is sin(θ) = opposite/hypotenuse. C) Incorrect; this is tan(θ) = opposite/adjacent. D) Incorrect; this is the reciprocal of tan(θ).',
    topic: 'Trigonometric Ratios (SOH-CAH-TOA)'
  },
  {
    id: 3,
    ...
    answer: 2,
    explanation: 'According to the mnemonic SOH-CAH-TOA, tangent is the ratio of the opposite side to the adjacent side: tan(θ) = opposite/adjacent. A) Incorrect; this defines sine, not tangent. B) Incorrect; this defines cosine, not tangent. D) Incorrect; this is the reciprocal of tangent (cotangent).',
    topic: 'Trigonometric Ratios (SOH-CAH-TOA)'
  },
  {
    id: 4,
    ...
    answer: 1,
    explanation: 'By the cofunction identity, cos(90° − θ) = sin(θ). Since sin(θ) = 0.6, it follows that cos(90° − θ) = 0.6. A), C), D) Incorrect; do not apply the cofunction (complementary angle) identity correctly.',
  ...
  },
  {
    ...
    options: ['3', '6', '6√2', '12'],
    answer: 1,
    explanation: 'In a 45°-45°-90° triangle, the hypotenuse equals leg × √2. Setting leg × √2 = 6√2 and dividing both sides by √2 gives leg = 6. A) Incorrect; this is half the correct value. C) Incorrect; this is the hypotenuse, not the leg. D) Incorrect; this is double the correct value.',
    topic: 'Special Right Triangles (45-45-90)'
  },
  {
    id: 7,
  ...
  },
  {
    ...
    answer: 0,
    explanation: 'In a 30°-60°-90° triangle, the side opposite the 30° angle is half the hypotenuse, so sin(30°) = opposite/hypotenuse = (1/2 × hypotenuse)/hypotenuse = 1/2. B) Incorrect; this is the value of sin(45°). C) Incorrect; this is the value of sin(60°). D) Incorrect; this would be the value of sin(90°).',
  ...
  },
  {
    ...
    options: ['1/2', '√2/2', '√3/2', '1'],
    answer: 0,
    explanation: 'Using the cofunction identity, cos(60°) = sin(30°) = 1/2. B) Incorrect; this is the value of cos(45°) (or sin(45°)). C) Incorrect; this is the value of cos(30°) (or sin(60°)). D) Incorrect; this would be the value of cos(0°).',
    topic: 'Common Trigonometric Values'
  },
  {
    id: 11,
    ...
    answer: 0,
    explanation: 'On the unit circle, the y-coordinate of the point where the angle intersects the circle gives the sine of that angle. For 45°, the point is (√2/2, √2/2), so sin(45°) = √2/2. B) Incorrect; this is the value of sin(30°). C) Incorrect; this is the value of sin(60°). D) Incorrect; this would only occur at 90°.',
  ...
  },
  {
    ...
    options: ['0', '1', '2', 'tan(θ)'],
    answer: 1,
    explanation: 'The Pythagorean identity states that for any angle θ, sin²(θ) + cos²(θ) = 1, derived directly from the Pythagorean theorem applied to the unit circle. A), C), D) Incorrect; none of these match the fundamental Pythagorean identity in trigonometry.',
  ...
  },
  {
    ...
    options: ['3/5', '4/5', '3/4', '4/3'],
    answer: 0,
    explanation: 'The side opposite θ has length 6 and the hypotenuse has length 10, so sin(θ) = opposite/hypotenuse = 6/10 = 3/5. B) Incorrect; this is cos(θ) = adjacent/hypotenuse = 8/10 = 4/5. C) Incorrect; this is tan(θ) = opposite/adjacent = 6/8 = 3/4. D) Incorrect; this is the reciprocal of tan(θ).',
    topic: 'Trigonometric Ratios (SOH-CAH-TOA)'
  },
  {
    id: 15,
  ...
  },
  {
    ...
    options: ['5/13', '12/13', '5/12', '12/5'],
    answer: 1,
    explanation: 'In a 5-12-13 right triangle, if cos(θ) = adjacent/hypotenuse = 5/13, then the adjacent side is 5 and the hypotenuse is 13. The remaining leg (opposite side) must be 12. Therefore, sin(θ) = opposite/hypotenuse = 12/13. A) Incorrect; this is cos(θ), not sin(θ). C) Incorrect; this is tan(θ), not sin(θ). D) Incorrect; this is the reciprocal of tan(θ).',
    topic: 'Trigonometric Ratios (SOH-CAH-TOA)'
  },
  {
    id: 19,
  ...
  },
  {
    ...
    options: ['0°', '45°', '60°', '90°'],
    answer: 3,
    explanation: 'On the unit circle, cosine represents the x-coordinate of a point. The x-coordinate is 0 when the angle is 90° (the point is directly on the y-axis). A) Incorrect; cos(0°) = 1, not 0. B) Incorrect; cos(45°) = √2/2, not 0. C) Incorrect; cos(60°) = 1/2, not 0.',
    topic: 'The Unit Circle'
  },
  {
    id: 21,
  ...
  },
  {
    ...
    options: ['30°', '45°', '60°', '90°'],
    answer: 0,
    explanation: 'Since sin(30°) = 1/2 = 0.5, and θ is given as acute (between 0° and 90°), θ = 30°. B) Incorrect; sin(45°) = √2/2 ≈ 0.707, not 0.5. C) Incorrect; sin(60°) = √3/2 ≈ 0.866, not 0.5. D) Incorrect; sin(90°) = 1, not 0.5.',
    topic: 'Inverse Trigonometric Functions'
  },
  {
    id: 25,
