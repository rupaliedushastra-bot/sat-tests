const QUESTIONS = [
  {
    "id": 1,
    "text": "Passage:\nMany scientists believe that climate change is causing more frequent and\nsevere weather events. They point to the increasing number of hurricanes,\ndroughts, and heatwaves as evidence. However, some argue that these\nevents have always occurred and that attributing them to climate change is\nspeculative.\n\nQuestion:\nWhich choice best describes the author's attitude toward the claim that\nclimate change is causing more severe weather events?",
    "options": [
      "Neutral, presenting both sides without bias",
      "Supportive, strongly agreeing with the scientists",
      "Skeptical, doubting the scientists' claims",
  ...
  {
    "id": 2,
    "text": "Passage:\nThe company announced its new sustainability initiative last Monday. This\nprogram aims to reduce waste, increase recycling efforts, and promote the\nuse of renewable energy.\n\nQuestion:\nWhich word could best replace \"announced\" in the passage without\nchanging the meaning?",
    "options": [
      "Declared",
      "Whispered",
      "Questioned",
  ...
  {
    "id": 3,
    "text": "Passage:\nThe committee will meet next week to discuss the budget proposal. Their\ngoal is to find ways to cut costs without sacrificing quality.\n\nQuestion:\nWhat is the main purpose of the committee's meeting?",
    "options": [
      "To create a new budget",
      "To approve the budget proposal",
      "To discuss ways to reduce expenses",
  ...
  {
    "id": 4,
    "text": "Passage:\nIn the novel, the protagonist faces numerous challenges that test her\nstrength and resilience. Despite these obstacles, she remains determined to\nachieve her goals.\n\nQuestion:\nWhich choice best describes the protagonist's character?",
    "options": [
      "Passive and fearful",
  ...
  {
    "id": 5,
    "text": "Passage:\nRecent studies have shown that regular exercise can improve mental health.\nParticipants who engaged in physical activities reported lower levels of\nanxiety and depression compared to those who did not.\n\nQuestion:\nWhat can be inferred from the passage about the relationship between\nexercise and mental health?",
    "options": [
      "Exercise causes anxiety and depression.",
      "There is no connection between exercise and mental health.",
      "Regular exercise may help reduce anxiety and depression.",
  ...
  {
    "id": 6,
    "text": "Passage:\nMany experts recommend that students take short breaks during study\nsessions. These breaks can help improve concentration and prevent burnout.\n\nQuestion:\nWhich choice best captures the main idea of the passage?",
    "options": [
      "Short breaks are essential for students' physical health.",
      "Experts suggest that students should avoid long study sessions.",
      "Taking short breaks can enhance focus and avoid burnout.",
  ...
  {
    "id": 7,
    "text": "Passage:\nThe city council has approved a new public transportation plan that includes\nthe construction of bike lanes and the expansion of bus routes.\n\nQuestion:\nWhich word could best replace \"approved\" in the passage without changing\nthe meaning?",
    "options": [
      "Rejected",
      "Disregarded",
      "Authorized",
  ...
  {
    "id": 8,
    "text": "Passage:\nThe scientist's groundbreaking research has opened up new possibilities in\nthe field of renewable energy. Her work is considered a major advancement.\n\nQuestion:\nWhat does the passage imply about the scientist's research?",
    "options": [
      "It has been ignored by the scientific community.",
      "It is a minor contribution to the field.",
      "It has led to significant progress in renewable energy.",
  ...
  {
    "id": 9,
    "text": "Passage:\nAlthough the recipe called for two cups of sugar, he decided to use only one\ncup. The result was a dessert that was less sweet but still delicious.\n\nQuestion:\nWhat can be inferred about the dessert from the passage?",
    "options": [
  ...
  {
    "id": 10,
    "text": "Passage:\nThe new smartphone model boasts several innovative features, including an\nadvanced camera system and a longer-lasting battery.\n\nQuestion:\nWhich choice best describes the tone of the passage?",
    "options": [
      "Critical",
      "Enthusiastic",
      "Indifferent",
  ...
  {
    "id": 11,
    "text": "Passage:\nScientists have observed a significant decrease in bee populations\nworldwide. This decline could have serious consequences for global food\nproduction, as bees play a crucial role in pollinating many crops.\n\nQuestion:\nWhich of the following statements is best supported by the passage?",
    "options": [
      "The decrease in bee populations will only affect honey production.",
      "Scientists are not concerned about the decline in bee populations.",
      "The decline in bee populations could impact food production globally.",
  ...
  {
    "id": 13,
    "text": "Passage:\nThe committee implemented new policies to improve employee wellness.\nThese policies include flexible work hours, access to fitness facilities, and\nmental health support.\n\nQuestion:\nWhich policy is NOT mentioned as part of the new wellness initiatives?",
    "options": [
      "Flexible work hours",
  ...
  {
    "id": 14,
    "text": "Passage:\nAlthough the conference was scheduled to end at 5 PM, it ran over by an\nhour due to the extended question-and-answer session. The attendees didn't\nmind, as they found the discussions highly informative.\n\nQuestion:\nWhat can be inferred about the attendees' reaction to the extended\nconference?",
    "options": [
      "They were frustrated by the delay.",
      "They appreciated the extra time for discussions.",
      "They left the conference early.",
  ...
  {
    "id": 15,
    "text": "Passage:\nThe new restaurant quickly gained popularity due to its innovative menu\nand excellent customer service. Many patrons praised the unique flavors\nand friendly staff.\n\nQuestion:\nWhat contributed to the restaurant's popularity?",
    "options": [
      "Low prices and convenient location",
      "Innovative menu and excellent customer service",
      "Traditional recipes and quick service",
  ...
  {
    "id": 17,
    "text": "Passage:\nThe research team discovered a new species of insect in the Amazon\nrainforest. This discovery highlights the region's incredible biodiversity and\nthe importance of conservation efforts.\n\nQuestion:\nWhat does the discovery of the new insect species emphasize?",
    "options": [
      "The challenges of scientific research",
      "The dangers of the Amazon rainforest",
      "The biodiversity of the Amazon and need for conservation",
  ...
  {
    "id": 18,
    "text": "Passage:\nThe school board decided to implement a new curriculum that focuses on\nproject-based learning. This approach encourages students to apply their\nknowledge to real-world problems.\n\nQuestion:\nWhat is the primary goal of the new curriculum?",
    "options": [
      "To increase standardized test scores",
      "To promote project-based learning",
      "To reduce homework assignments",
  ...
  {
    "id": 19,
    "text": "Passage:\nThe local government launched a campaign to promote recycling. The\ncampaign includes educational programs, incentives for businesses, and\nimproved recycling facilities.\n\nQuestion:\nWhich of the following is NOT part of the local government's recycling\ncampaign?",
    "options": [
  ...
  {
    "id": 20,
    "text": "Passage:\nAfter conducting a thorough review of the data, the scientists concluded\nthat the new treatment was both safe and effective. They plan to publish\ntheir findings in a medical journal.\n\nQuestion:\nWhat is the scientists' conclusion about the new treatment?",
    "options": [
      "It is safe but not effective.",
      "It is effective but not safe.",
  ...
  {
    "id": 21,
    "text": "Passage:\nIn recent years, there has been a surge in the popularity of urban gardening.\nThese small, city-based gardens provide residents with fresh produce and a\nsense of community.\n\nQuestion:\nWhich of the following is a benefit of urban gardening mentioned in the\npassage?",
    "options": [
      "It reduces pollution levels.",
      "It provides fresh produce.",
  ...
  {
    "id": 22,
    "text": "Passage:\nThe author argues that renewable energy sources, such as wind and solar\npower, are essential for combating climate change. These energy sources\nare sustainable and produce little to no greenhouse gases.\n\nQuestion:\nWhat is the author's main argument in the passage?",
    "options": [
      "Wind and solar power are expensive.",
      "Renewable energy sources are essential for combating climate change.",
  ...
  {
    "id": 23,
    "text": "Passage:\nMany companies are adopting flexible work policies to attract and retain\ntalented employees. These policies include options for remote work,\nflexible hours, and compressed workweeks.\n\nQuestion:\nWhich of the following is NOT mentioned as part of the flexible work\npolicies?",
    "options": [
      "Remote work options",
      "Flexible hours",
  ...
  {
    "id": 24,
    "text": "Passage:\nThe city council's new initiative aims to reduce traffic congestion by\nimproving public transportation. This includes expanding bus routes and\nadding more bike lanes.\n\nQuestion:\nWhat is the primary goal of the city council's new initiative?",
    "options": [
  ...
  {
    "id": 25,
    "text": "Passage:\nThe invention of the printing press revolutionized the way information was\nshared and consumed. It enabled mass production of books, making\nliterature and knowledge accessible to a broader audience.\n\nQuestion:\nWhat was one significant impact of the invention of the printing press?",
    "options": [
      "It increased the cost of books.",
      "It limited access to literature and knowledge.",
      "It enabled mass production of books.",
  ...
  {
    "id": 26,
    "text": "Passage:\nStudies have shown that regular physical activity can improve mental health\nby reducing anxiety and depression. Exercise releases endorphins, which\nare chemicals in the brain that act as natural mood lifters.\n\nQuestion:\nAccording to the passage, how does regular physical activity benefit mental\nhealth?",
    "options": [
      "By increasing stress levels",
      "By reducing anxiety and depression",
      "By lowering endorphin levels",
      "By causing fatigue"
    ],
    "answer": 1,
  ...
  {
    "id": 27,
    "text": "Passage:\nMany historians believe that the construction of the Great Wall of China\nwas a significant achievement in ancient engineering. The wall was built to\nprotect Chinese states from invasions and raids.\n\nQuestion:\nWhat was the primary purpose of building the Great Wall of China?",
    "options": [
      "To promote trade",
  ...
  {
    "id": 28,
    "text": "Passage:\nThe new library design incorporates several eco-friendly features, such as\nsolar panels, green roofs, and energy-efficient lighting. These features not\nonly reduce the building's environmental impact but also lower operational\ncosts.\n\nQuestion:\nWhat is one benefit of the eco-friendly features in the new library design?",
    "options": [
      "They increase the building's environmental impact.",
      "They raise operational costs.",
      "They reduce the building's environmental impact.",
  ...
  {
    "id": 29,
    "text": "Passage:\nThe development of smartphones has dramatically changed how people\ncommunicate. With access to instant messaging, social media, and video\ncalls, staying connected with friends and family has never been easier.\n\nQuestion:\nHow have smartphones changed communication according to the passage?",
    "options": [
      "They have made communication more difficult.",
      "They have limited access to instant messaging.",
      "They have made staying connected easier.",
  ...
  {
    "id": 30,
    "text": "Passage:\nThe scientist's groundbreaking research on renewable energy sources\nearned her numerous accolades. Her work has paved the way for new\nadvancements in sustainable technology.\n\nQuestion:\nWhat is one outcome of the scientist's research mentioned in the passage?",
    "options": [
      "It led to a decrease in renewable energy sources.",
      "It earned her numerous accolades.",
      "It prevented advancements in sustainable technology.",
  ...
  {
    "id": 31,
    "text": "Passage:\nRecent studies suggest that spending time in nature can significantly reduce\nstress levels. Activities such as walking in a park or hiking in the woods\nhave been shown to lower cortisol, the body's main stress hormone.\n\nQuestion:\nAccording to the passage, what is one benefit of spending time in nature?",
    "options": [
  ...
  {
    "id": 32,
    "text": "Passage:\nThe rise of remote work has led to an increased demand for home office\nequipment. Companies specializing in ergonomic chairs and desks have\nseen their sales surge as more people set up workspaces at home.\n\nQuestion:\nWhat is one effect of the rise of remote work mentioned in the passage?",
    "options": [
      "A decrease in home office equipment sales",
      "An increase in demand for ergonomic chairs and desks",
      "More people commuting to offices",
  ...
  {
    "id": 33,
    "text": "Passage:\nThe novel's protagonist is a young woman who defies societal expectations\nby pursuing a career in science. Her journey is filled with challenges, but\nher determination and passion drive her to succeed.\n\nQuestion:\nWhat is the main theme of the novel mentioned in the passage?",
    "options": [
      "The importance of societal expectations",
      "The challenges of pursuing a career in science",
      "The protagonist's determination and passion",
  ...
  {
    "id": 34,
    "text": "Passage:\nThe local government has implemented a new recycling program to reduce\nwaste. Residents are encouraged to separate their recyclables from their\ntrash and use the provided bins for collection.\n\nQuestion:\nWhat is the purpose of the new recycling program mentioned in the\npassage?",
    "options": [
  ...
  {
    "id": 35,
    "text": "Passage:\nAdvancements in medical technology have made it possible to perform\ncomplex surgeries with minimally invasive techniques. These procedures\noften result in shorter recovery times and fewer complications for patients.\n\nQuestion:\nWhat is one advantage of minimally invasive surgeries mentioned in the\npassage?",
    "options": [
  ...
  {
    "id": 36,
    "text": "Passage:\nThe success of the community garden project is largely due to the\nvolunteers' dedication. Their hard work and commitment have transformed\na vacant lot into a thriving garden that provides fresh produce for local\nresidents.\n\nQuestion:\nWhat has contributed most to the success of the community garden project\naccording to the passage?",
    "options": [
      "Government funding",
  ...
  {
    "id": 39,
    "text": "In the context of the following passage, what does the word \"elusive\" most\nnearly mean?\nPassage Excerpt: \"Despite extensive research, the cause of the disease\nremains elusive.\"",
    "options": [
      "clear",
      "visible",
      "known",
  ...
  {
    "id": 40,
    "text": "Which sentence best concludes a paragraph about the importance of\nlearning multiple languages?",
    "options": [
      "Many people speak more than one language fluently.",
      "It is often challenging to learn a new language as an adult.",
      "Learning multiple languages can open doors to various career\nopportunities and enhance cognitive abilities.",
  ...
  {
    "id": 41,
    "text": "In the context of the sentence, which choice best completes the sentence?\nSentence: \"The researchers conducted several experiments to test the new\nhypothesis, and their results were ______________.\"",
    "options": [
      "inconclusive",
      "positive",
      "quick",
  ...
  {
    "id": 42,
    "text": "Which choice best describes the function of the underlined portion in the\nsentence?\nSentence: \"By examining the evidence thoroughly, the committee was able\nto make a well-informed decision.\"",
    "options": [
      "It introduces a reason for the decision.",
      "It contrasts with the decision.",
  ...
  {
    "id": 43,
    "text": "Which sentence would best support a paragraph about the benefits of\nregular exercise?",
    "options": [
      "Many people go to the gym to work out.",
      "Regular exercise has been shown to improve mental health, boost energy\nlevels, and reduce the risk of chronic diseases.",
  ...
  {
    "id": 44,
    "text": "In the context of the following passage, what does the word \"facilitate\"\nmost nearly mean?\nPassage Excerpt: \"To facilitate the smooth operation of the event, the\norganizers assigned specific tasks to each volunteer.\"",
    "options": [
      "hinder",
      "complicate",
      "observe",
  ...
  {
    "id": 46,
    "text": "Which sentence best transitions from a discussion about the challenges of\nclimate change to the potential solutions?",
    "options": [
      ...
      "Many scientists are working on innovative solutions to mitigate the\neffects of climate change.",
  ...
  {
    "id": 48,
    "text": "In the context of the following passage, what does the word \"ambiguous\"\nmost nearly mean?\nPassage Excerpt: \"The instructions were ambiguous, leading to confusion\namong the team members.\"",
    "options": [
      "clear",
      "confusing",
      "lengthy",
  ...
  {
    "id": 49,
    "text": "Which sentence best supports a paragraph discussing the impact of social\nmedia on communication?",
    "options": [
  ...
  {
    "id": 51,
    "text": "Which choice best completes the sentence with relevant and specific\ninformation?\nSentence: \"The new policy aims to reduce carbon emissions,\n______________.\"",
    "options": [
  ...
  {
    "id": 52,
    "text": "In the context of the passage, what does the word \"alleviate\" most nearly\nmean?\nPassage Excerpt: \"To alleviate the overcrowding issue, the city council\nproposed the construction of new housing units.\"",
    "options": [
      "worsen",
      "ignore",
      "lessen",
  ...
  {
    "id": 53,
    "text": "Which choice best describes the function of the underlined portion in the\nsentence?\nSentence: \"Given the limited budget, the team decided to focus on the most\ncritical issues first.\"",
    "options": [
  ...
  {
    "id": 54,
    "text": "Which sentence would best support a paragraph about the importance of\nsleep for overall health?",
    "options": [
      "Many people struggle to get enough sleep each night.",
      "Adequate sleep is essential for maintaining cognitive function, emotional\nstability, and physical health.",
  ...
  {
    "id": 57,
    "text": "If the area of a rectangle is 24 square units and the width is 4 units, what is\nthe length of the rectangle?",
    "options": [
      "6",
      "8",
      "10",
  ...
  {
    "id": 62,
    "text": "What is the slope of the line that passes through the points (1, 2) and (4, 8)?",
    "options": [
      "2",
      "3",
      "4",
  ...
  {
    "id": 71,
    "text": "If the area of a triangle is 24 square units and the base is 8 units, what is the\nheight of the triangle?",
    "options": [
      "3",
      "4",
      "5",
  ...
  {
    "id": 77,
    "text": "A rectangle has a length of 10 units and a width of 4 units. What is the area\nof the rectangle?",
    "options": [
      "14 square units",
      "20 square units",
      "40 square units",
  ...
  {
    "id": 87,
    "text": "A triangle has sides of lengths 3, 4, and 5. What is the perimeter of the\ntriangle?",
    "options": [
      "9",
      "10",
      "11",
