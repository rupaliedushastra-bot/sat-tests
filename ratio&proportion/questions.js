// =============================================
// Digital SAT – Topic: Ratio & Proportion
// questions.js | Ratio_and_Proportion_for_SAT.pdf
// 29 Questions | Made by Ranjit Sarangi
// =============================================
...
const QUESTIONS = [
    {
        ...
        options: ["Rs. 120, Rs. 240, Rs. 150", "Rs. 60, Rs. 90, Rs. 360", "Rs. 150, Rs. 300, Rs. 60", "None of these"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Rs. 122", "Rs. 129.60", "Rs. 146.60", "Rs. 183"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Rs. 140", "Rs. 160", "Rs. 240", "Rs. 320"],
        answer: 1,
    ...
    },
    {
        ...
        options: ["Rs. 21,000", "Rs. 26,000", "Rs. 28,000", "Data inadequate"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["12", "39", "54", "None of these"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Rs. 20,000", "Rs. 24,000", "Rs. 28,000", "Rs. 32,000"],
        answer: 0,
    ...
    },
    {
        ...
        options: ["Rs. 195", "Rs. 200", "Rs. 225", "Rs. 245"],
        answer: 3,
    ...
    },
    {
        ...
        options: ["Rs. 605", "Rs. 790", "Rs. 800", "Rs. 810"],
        answer: 3,
    ...
    {
        id: 26,
        text: `The ratio between two numbers is 3 : 4 and their L.C.M. is 180. The first number is:`,
        options: ["60", "45", "20", "15"],
        answer: 1,
        explanation: "Numbers = 3k and 4k. LCM = 12k = 180 → k = 15. First number = 3×15 = 45. Answer: B.",
        topic: "LCM & HCF"
    },
    {
        id: 27,
        text: `An alloy is to contain copper and zinc in the ratio 9 : 4. The zinc required to be melted with 24 kg of copper is:`,
        options: ["10 2/3 kg", "10 1/3 kg", "9 2/3 kg", "9 kg"],
        answer: 0,
        explanation: "9 parts = 24 kg → 1 part = 8/3 kg. Zinc = 4 parts = 32/3 = 10⅔ kg. Answer: A.",
        topic: "Alloy & Mixture"
    },
    {
        id: 28,
        text: `60 kg of an alloy A is mixed with 100 kg of alloy B. If alloy A has lead and tin in the ratio 3 : 2, and alloy B has tin and copper in the ratio 1 : 4, then the amount of tin in the new alloy is:`,
        options: ["36 kg", "44 kg", "53 kg", "80 kg"],
        answer: 1,
        explanation: "Tin in A = (2/5)×60 = 24 kg. Tin in B = (1/5)×100 = 20 kg. Total tin = 44 kg. Answer: B.",
        topic: "Alloy & Mixture"
    },
    {
        id: 29,
        text: `Gold is 19 times as heavy as water and copper is 9 times as heavy as water. In what ratio should these be mixed to get an alloy 15 times as heavy as water?`,
        options: ["1 : 1", "2 : 3", "1 : 2", "3 : 2"],
        answer: 3,
        explanation: "By alligation: Gold side = 15−9 = 6 parts, Copper side = 19−15 = 4 parts. Ratio Gold:Copper = 6:4 = 3:2. Answer: D.",
        topic: "Alligation"
    }
];
