...
const QUESTIONS = [
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. The passage states that capturing and sequestering carbon dioxide \"might double the cost of generating electricity,\" but because sequestration \"does not affect the cost of electricity transmission and distribution, delivered prices will rise less, by no more than 50 percent.\" If doubling the generation cost only raises the total delivered price by at most 50%, then generation cost must currently make up at most half of the delivered price — otherwise doubling it would raise the total by more than 50%. This supports C.",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. The passage states that sequestration would \"double the cost of generating electricity,\" raising the generation's share of the total delivered price. But it also states that \"research into better technologies for capturing carbon dioxide will undoubtedly lead to lowered costs,\" meaning the generation proportion would first rise (as sequestration is adopted) and then decline (as technology improves). This supports B. The other options introduce consequences — ceasing carbon production, reducing fuel consumption, or eliminating policymaker concerns — that the passage does not support.",
    "topic": "Set 3 – Passage A: Carbon Sequestration"
  },
  {
    "id": 17,
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. The passage explicitly embraces variety — essays that are \"short, terse, and informal,\" as well as ones resembling \"causeries or propos\" — and treats genre-based (\"taxonomic\") judgments as \"dull and irrelevant,\" using \"overall value\" as the criterion. This directly contradicts B, which claims essays following \"strict rules\" are superior. A, C, D, and E are all supported by the passage.",
    "topic": "Set 3 – Passage C: David Foster Wallace"
  },
  {
    "id": 23,
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. The passage describes New York with admiration—\"orchids, thick rugs,\" \"simple surprises,\" painterly \"metaphorical moments\"—reflecting an impressed tone, while also noting the gritty, unpleasant aspects: \"gated and padlocked streets,\" trees \"like invalid aunts,\" \"black plastic mountains of trash and the smell of dog urine\"—reflecting a critical tone. This dual perspective matches A. B's \"sardonic\" doesn't capture the genuine appreciation; C's \"detached\" contradicts the vivid emotional engagement; D and E don't capture both positive and negative aspects.",
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. The passage discusses liberation and liberalization at a conceptual level throughout, citing Marcuse's distinction, but never provides a concrete, specific example (such as a named event, product, or scenario) to illustrate the abstract argument. This makes C the exception. A is present (what \"has passed as liberation\" is often its opposite); B is present in the final sentence's conclusion; D is present in the paradoxical idea that freeing possessions makes them \"no longer native to you\"; E is present in the comparison drawn between liberation and liberalization.",
    "topic": "Set 3 – Passage F: Liberation"
  },
  {
    "id": 32,
