...
function renderResults(result, saveRes) {
    ...
    <div class="inc-review">
      ...
      ${details.filter(d => d.status !== 'correct').map(q => `
        <div class="inc-q">
          <div style="font-size:0.72rem;font-weight:600;color:${TOPIC_COLORS[q.topic] || 'var(--accent)'};margin-bottom:4px;text-transform:uppercase;letter-spacing:0.05em;">${q.topic}</div>
