...
const QUESTIONS = [
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. Let the three terms be T₁, T₂, T₃. Given abc = 1 => c = 1/(ab), c⁻¹ = ab, b⁻¹ = 1/b.\nT₁ = 1 / (1 + a + 1/b) = b / (b + ab + 1)\nT₂ = 1 / (1 + b + ab) = 1 / (ab + b + 1)\nT₃ = 1 / (1 + c + 1/a) = 1 / (1 + 1/ab + 1/a) = ab / (ab + b + 1)\nSumming them:\nT₁ + T₂ + T₃ = (b + 1 + ab) / (ab + b + 1) = 1.",
    "topic": "Advanced Math"
  }
];
