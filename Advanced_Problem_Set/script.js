// =============================================
// script.js – Advanced Problem Set
// Digital SAT Practice | EduQuest
// 15 Questions | SAT Math – Advanced Math
// =============================================
...
function renderResults(result, saveRes) {
    ...
    wrap.innerHTML = `
    <div class="res-hero">
      <div style="font-size:0.8rem;opacity:.55;text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px">Advanced Problem Set · Topic Test</div>
...
function downloadPDF() {
    ...
    html2pdf().set({
        margin: [10, 10, 10, 10],
        filename: `EduQuest_Report_${student.name.replace(/[^a-zA-Z0-9]/g, '_')}_Advanced_Problem_Set.pdf`,
