// =============================================
// Digital SAT – Practice Exam 3
// Module 1: English/Reading & Writing (33Q)
// Source: https://test.eduquest.org.in/sat-english-module-1/
...
const E3_RW_M1 = [
  ...
  },
  {
    ...
    text: 'Celebrated Tewa potter Maria Martinez (1887–1980) made her signature all-black ceramic vessels using a heating technique called reduction firing. This technique involves smothering the flame surrounding the clay vessel. _______ the vessel takes on a shiny, black hue.\n\nWhich choice completes the text with the most logical transition?',
    options: [
      'On the contrary,',
      'For example,',
      'Previously,',
  ...
  },
  {
    ...
    text: 'Historians agree that the jazz pianist Jelly Roll Morton was exaggerating when he claimed to have invented jazz music. No one can deny, _______ that Morton\'s innovative compositions and remarkable improvisational skills helped shape jazz as a genre during its early years.\n\nWhich choice completes the text with the most logical transition?',
    options: [
      'therefore,',
      'in the second place,',
      'in other words,',
  ...
  },
  {
    ...
    text: 'What makes the theremin a unique musical instrument? You play it without touching it. When you place your _______ the pitch will shift as your hands move through the air.\n\nWhich choice completes the text with the most logical transition?',
    options: [
  ...
  },
  {
    ...
    text: 'In 1929, Edwin Herbert Land invented a polarizing filter that was featured in a number of products, from sunglasses to 3D movies. A decade later, Land _______ his technology to invent the world\'s first instant camera, the Polaroid Land camera.\n\nWhich choice completes the text so that it conforms to the conventions of Standard English?',
    options: [
      'used',
      'to have used',
      'to use',
  ...
  },
  {
    ...
    text: 'Lê Lương Minh became the thirteenth secretary-general of the Association of Southeast Asian Nations (ASEAN) in January 2013, making _______ the first time the organization would appoint a Vietnamese leader.\n\nWhich choice completes the text so that it conforms to the conventions of Standard English?',
    options: [
      'these',
      'those',
      'this',
  ...
  },
  {
    ...
    image: 'https://test.eduquest.org.in/wp-content/uploads/2026/04/Screenshot-2026-04-07-173020-300x293.png',
  ...
  },
  {
    ...
    text: '"The Yellow Wallpaper" is an 1892 short story by Charlotte Perkins Gilman. In the story, the narrator expresses mixed feelings about her surroundings: _______\n\nWhich quotation from "The Yellow Wallpaper" most effectively illustrates the claim?',
    options: [
  ...
  },
  {
    ...
    text: '"The Bet" is an 1889 short story by Anton Chekhov. In the story, a banker is described as being very upset about something: _______\n\nWhich quotation from "The Bet" most effectively illustrates the claim?',
    options: [
  ...
  {
    id: 29, section: 'rw', module: 1,
    text: 'Despite the generalizations about human behavior they have produced, many studies of behavioral psychology have used highly unrepresentative subject pools: students at the colleges and universities where the researchers are employed. To _______ this situation, it is necessary to actively recruit subjects from diverse backgrounds and locations.\n\nWhich choice completes the text with the most logical and precise word or phrase?',
    options: [
      'sanction',
      'ameliorate',
      'rationalize',
  ...
  {
    id: 31, section: 'rw', module: 1,
    text: 'K.D. Leka and colleagues found that the Sun\'s corona provides an advance indication of solar flares—intense eruptions of electromagnetic radiation that emanate from active regions in the Sun\'s photosphere and can interfere with telecommunications on Earth. Preceding a flare, the corona temporarily exhibits increased brightness above the region where the flare is _______.\n\nWhich choice completes the text with the most logical and precise word or phrase?',
    options: [
      'antecedent',
      'impending',
      'innocuous',
  ...
  {
    id: 32, section: 'rw', module: 1,
    text: 'Many ancient sculptures of people\'s heads are missing their noses. This is because the nose is the most ________ part of a sculpture of a person\'s head. It is delicate and sticks out from the rest of the sculpture, making it especially easy to break.\n\nWhich choice completes the text with the most logical and precise word or phrase?',
    options: [
      'recognizable',
      'fragile',
      'common',
...
// ── Combine all questions for Exam 3 ──────────
// Currently only Module 1 (English) is available
// Module 2 placeholder – add when available
const QUESTIONS3 = [...E3_RW_M1];

// ── Module config for Exam 3 ─────────────────
// Single module for now (English M1 only: 33Q, 39min)
const MODULE_MAP3 = {
  1: { id: 1, label: 'Module 1 – Reading & Writing', timeMin: 39, startIdx: 0, count: 33 },
};

// ── Topic Map ─────────────────────────────────
const TOPIC_MAP3 = {
  'Words in Context':             { name: 'Words in Context',             questions: QUESTIONS3.filter(q => q.topic === 'Words in Context').map(q => q.id) },
  'Craft and Structure':          { name: 'Craft and Structure',          questions: QUESTIONS3.filter(q => q.topic === 'Craft and Structure').map(q => q.id) },
  'Information and Ideas':        { name: 'Information and Ideas',        questions: QUESTIONS3.filter(q => q.topic === 'Information and Ideas').map(q => q.id) },
  'Standard English Conventions': { name: 'Standard English Conventions', questions: QUESTIONS3.filter(q => q.topic === 'Standard English Conventions').map(q => q.id) },
  'Rhetorical Synthesis':         { name: 'Rhetorical Synthesis',         questions: QUESTIONS3.filter(q => q.topic === 'Rhetorical Synthesis').map(q => q.id) },
};