...
const QUESTIONS = [
  {
    "id": 1,
    "text": "St. Joseph Atoll in the Seychelles was made a\nmarine protected area in 2020 because it contains\nlarge seabird colonies and has a large amount of\nmarine biodiversity.\nit is home to one of\nthe healthiest inland shark populations in the\nIndian Ocean.\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "Furthermore,",
      "Similarly,",
      "Conversely,",
  ...
  {
    "id": 2,
    "text": "Ahmes, an Egyptian who lived from\napproximately 1680 to 1620 BC, wrote one of the\noldest known mathematical documents, a papyrus\ndivided into multiple sections which has become\none of the main sources of information about\nancient Egyptian mathematics.\nAhmes\nclaims in the preface that he was not the author\nbut merely a scribe who copied calculations from\ncenturies before.\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "Consequently,",
      "However,",
      "Subsequently,",
  ...
  {
    "id": 3,
    "text": "JIT is the abbreviation for \"Just in Time\"\nmanagement, which refers to a method of\nhandling inventory so that the goods are received\nfrom the supplier only when needed.\ngoal of the system is to increase turnover and\nreduce the costs of storing product that is not in\nuse.\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "Ultimately,",
      "Conversely,",
      "Nevertheless,",
  ...
  {
    "id": 4,
    "text": "Ishtaboli is a traditional game played by Choctaw\nNative Americans who lived in an area that is\nnow Oklahoma. A form of stickball, the game\nhas players that hit or pass a ball with sticks into\na goal, but there are virtually no rules.\ngame was suppressed by the U.S. government, but\nnow Choctaws play ishtaboli as an expression of\nculture and take pride in their heritage.\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "Simultaneously,",
      "Previously,",
      "For instance,",
  ...
  {
    "id": 5,
    "text": "Poison dart frogs have bright coloration to warn\npotential predators of their toxins.\nthey are\nactive during the day when their colors are most\nvisible, unlike most frogs, which are nocturnal.\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "Consequently,",
      "In conclusion,",
      "By contrast,",
  ...
  {
    "id": 6,
    "text": "George Orwell wrote the classic dystopian novel\nsome of the details are dated\n1984 in 1949.\nor seem quaint when looking back on what\nactually happened in that year, the book contains\nimportant messages that are still relevant today.\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "However,",
      "Because",
      "Since",
  ...
  {
    "id": 7,
    "text": "Paleoclimatologist Tanguy Racine of the\nUniversity of Innsbruck spends much of his time\nunderground in caves picking out twigs and pine\nneedles from melting ice. The information he\nretrieves from carbon dating these small objects\ngives valuable information about the formation,\nwaxing, and waning of the ice.\nhe can tease\nout details about the changes in the climate over\nhundreds of years.\nWhich choice completes the text with the most\nlogical transition ?",
    "options": [
      "By contrast,",
      "In turn,",
      "Nevertheless,",
  ...
  {
    "id": 8,
    "text": "Four of Jupiterk moons were identified in 1610 by\nthe astronomer Galileo: Io, Europa, Ganymede,\nand Calisto. Subsequently, other moons have\nbeen identified. with the count at 59 officially\nnamed moons.\nthere are also now 23 more\ncelestial bodies pending formal identification and\nnaming.\nWhich choice completes the text with the most\nlogical transition ?",
    "options": [
      "In conclusion,",
      "In reality,",
      "On one hand,",
  ...
  {
    "id": 9,
    "text": "Ihe first modern credit card was issued by Bank\nof America in 1958.\nthe idea of a credit\ncard predates that event by over 150 years: the\nterm was first used in the 1887 book Looking\nBackward by Edward Bellamy.\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "However,",
      "Specifically,",
      "Consequently,",
  ...
  {
    "id": 10,
    "text": "Whoopi Goldberg is the stage name of Caryn\nElaine Johnson, a talented actress and comedian.\nAs well as being only one of 17 people to earn all\nfour major perf\normance awards in the United\nStates (the Emmy, Grammy, Oscar, and Tony),\nshe is a human rights activist who has supported\nshe moderated the 2008\nmany causes.\nAlliance of Youth Movements Summit showing\nhow to fight violent extremism with social\nnetworks.\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "In other words,",
      "For example,",
      "On the other hand,",
  ...
  {
    "id": 11,
    "text": "Edvard Munch's iconic image, The Scream,\nwas first painted in 1893, though he actually\ncompleted two paintings, two pastels, and about\n40 lithographs, some hand-colored, of the same\ndesign. Both of the paintings have been stolen,\none in 1994 and one in 2004.\nboth were\nfound and returned to the museums where they\nhad been on display.\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "Therefore,",
      "Subsequently,",
      "Specifically,",
  ...
  {
    "id": 12,
    "text": "Obesity is a complex subject, and scientists have\nisolated over 244 genes in mice that are related to\nobesity. These genes are not just ones that regulate\nfat storage, _ They cover a wide range of\nmetabolic processes including food intake and the\ndrive to do exercise.\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "though.",
      "therefore.",
      "consequently.",
  ...
  {
    "id": 13,
    "text": "A flamingo is a filter feeder that holds the top of\nits mouth underwater until it fills with water, then\nshuts its mouth and pushes out the liquid through\ncomb-like structures.\nthe bird has to stand\nwith its head upside-down to eat this way.\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "Consequently,",
      "However,",
      "Finally,",
  ...
  {
    "id": 14,
    "text": "As human rights are becoming more inclusive,\ntransgender athletes are gaining more public\nawareness and acceptance.\ntransgender players participated in the 2020\nTokyo Olympic games, which were postponed to\n2021.\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "Likewise,",
      "For example,",
      "In addition,",
  ...
  {
    "id": 15,
    "text": "William Butler Keats is considered one of the\nforemost poets of the 20th century and was very\ninfluential in the Irish Literary Revival. He was\nalso deeply fascinated by mysticism and astrology.\nmany of his poems are deeply symbolic\nand have allusive imagery.\nWhich choice completes the text with the most\nlogical transition ?",
    "options": [
      "Howbeit,",
      "Likewise,",
      "Notwithstanding,",
  ...
  {
    "id": 17,
    "text": "Wildebeest herds, which can number over a\nmillion animals, have no leader for their annual\nmigrations that extend from Kenya to Tanzania.\nthey follow trails made by previous animals,\ndemonstrating an impressive form of group\nmemory.\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "For instance,",
      "In addition,",
      "Instead,",
  ...
  {
    "id": 18,
    "text": "A tax collector named Karl Doberman developed\nthe breed of dog named after him in the 1890s.\nMost people imagine Dobermans as black dogs\nwith tan markings on the face, legs, and belly.\nthe dogs also come in chocolate brown\n(also called red or rust), blue (a mutation of\nblack), and Isabella or fawn (a mutation of\nchocolate).\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "Specifically,",
      "For instance,",
      "However,",
  ...
  {
    "id": 19,
    "text": "In the district of Demak Regency in Jakarta,\nIndonesia, over 1,000 acres of land are lost to the\nocean each year. One contributing cause is the\nfact that global warming is making the sea level\nrise by about an eighth of an inch per year.\ndelayed monsoon seasons and tourism have led\nto draining of the underground water, causing the\nland to sink at a rate of up to four inches per year.\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "Secondly,",
      "Therefore,",
      "Consequently,",
  ...
  {
    "id": 20,
    "text": "In 2020, a review of 83 urban wildlife studies\nthat were conducted on six continents revealed\nthat 93 percent of the animal species studied\nhad distinct behavioral differences from their\nrural counterparts. This striking result is now\nprompting researchers to pursue a new line of\nare the changes merely behavioral,\nor are there genetic alterations as well?\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "Furthermore,",
      "Consequently,",
      "Namely,",
  ...
  {
    "id": 21,
    "text": "Venus is the only planet to rotate clockwise,\nwhich means that it is in effect, spinning upside-\ndown compared to Earth. In addition, the\nrotational period is the slowest of all the planets,\ntaking 243 Earth days to make one complete\nVenusian day.\nastronomers believe that the\nplanet probably was involved in a collision in the\ndistant past.\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "Conversely,",
      "Meanwhile,",
      "Hence,",
  ...
  {
    "id": 22,
    "text": "The potato, a staple food crop around the\nworld, originated in the South American Andes\nmountains and was domesticated about 8,000\nyears ago, but was not introduced in North\nAmerica until thousands of years later.\nit\nwas first brought to Europe in the mid- 1500s,\nthen spread westward to North America.\nWhich choice completes the text with the most\nlogical transition?",
    "options": [
      "Ironically,",
      "Therefore,",
      "Furthermore,",
  ...
  {
    "id": 23,
    "text": "Dendrochronology is the science of dating objects\nbased on the growth of tree rings, which vary in\nsize due to climatic changes such as temperature\nor availability of water. Scientists are able to\ncompare the growth across trees to compile a map\nthat can be compared to an unidentified piece\nof wood, such as one from a historic building,\nand accurately determine when the tree was\nthe map is so comprehensive\nthat scientists can now date wooden objects in the\nnorthern hemisphere to any period within the\npast 13,910 years.\nWhich choice completes the text with the most\neffective transition ?",
    "options": [
      "In fact,",
      "Therefore,",
      "Nonetheless,",
  ...
  {
    "id": 24,
    "text": "Slavery was officially abolished in 1865 with the\nThirteenth Amendment to the U.S. Constitution.\nequality was not legally established until\nalmost exactly a hundred years later, with the\nCivil Rights Act of 1964, in which discrimination\nbased on race, color, religion, sex or national\norigin was prohibited.\nWhich choice completes the text with the most\neffective transition?",
    "options": [
      "Likewise,",
      "Nevertheless,",
      "Consequently,",
  ...
  {
    "id": 25,
    "text": "Christopher Pissarides was born in Nicosia,\nCyprus, to a family that came from a small\nvillage in the Agaros mountains. It might\nbe expected that someone with that humble\nbackground would have a modest career,\nPissarides went on to earn the 2010 Nobel Prize\nin Economics for his theories governing search\nfrictions and macroeconomics.\nWhich choice completes the text with the most\neffective transition?",
    "options": [
      "and",
      "but",
      "since",
