...
const QUESTIONS = [
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. \"Committee\" is a collective noun and takes the singular pronoun \"it.\" Option C adds an unnecessary connector, and D is redundant with \"but.\"",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. A semicolon before a conjunctive adverb like \"otherwise\" correctly joins two independent clauses. A comma alone creates a comma splice (A), and C omits necessary punctuation entirely.",
    "topic": "Punctuation"
  },
  {
    "id": 3,
    ...
    "answer": 1,
    "explanation": "Choice B is correct. \"However\" implies contrast, but both clauses say the same thing. Removing \"however\" and using just a semicolon creates a correct compound sentence without false contrast. Option C creates a comma splice with \"however\" used as an interrupter.",
    "topic": "Punctuation"
  },
  {
    "id": 4,
    ...
    "answer": 1,
    "explanation": "Choice B is correct. A semicolon correctly joins two related independent clauses without a coordinator. Option C (colon) is incorrect as the second clause does not explain the first. Option D changes the meaning by implying the reason for visiting.",
    "topic": "Punctuation"
  },
  {
    "id": 5,
    ...
    "answer": 1,
    "explanation": "Choice B is correct. A semicolon correctly separates two independent clauses. Option C (colon) works only if the second clause explains the first directly — here a semicolon is more natural. Option D (comma + conjunction) is also acceptable but B is the most concise correction.",
    "topic": "Punctuation"
  },
  {
    "id": 6,
    ...
    "answer": 0,
    "explanation": "Choice A is correct. \"After the meeting ended\" is a correctly formed subordinate clause using the past tense verb \"ended.\" Option B creates a dangling modifier. Option C omits the comma needed after an introductory clause.",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Choice B is correct. \"And\" correctly joins two related events without implying contrast. \"But\" (A) wrongly implies surprise or opposition. \"However\" (C) without a comma is incorrect. \"While\" (D) implies simultaneity, not consequence.",
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. Option C directly states the main claim of the paragraph — that exercise improves mental health. Options A and B are off-topic (physical health and preference, respectively), and D focuses on scheduling rather than the mental health benefits.",
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. A concluding sentence should summarize the paragraph's main point. Option C does this directly. Options A, B, and D introduce new ideas or shift focus rather than concluding the paragraph's argument.",
    "topic": "Rhetorical Skills"
  },
  {
    "id": 10,
    ...
    "answer": 1,
    "explanation": "Choice B is correct. \"To ensure fairness\" is an infinitive phrase that explains the purpose (reason) behind the action — giving all candidates the same questions. It is a reason/purpose, not an example, contrast, or new topic.",
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Choice A is correct. \"By conducting a thorough review\" is a prepositional phrase explaining HOW (and thus WHY) the researcher ensured accuracy — it describes the method/reason for the action.",
    "topic": "Sentence Function"
  },
  {
    "id": 12,
    ...
    "answer": 2,
    "explanation": "Choice C is correct. \"Despite the rain\" introduces a contrasting condition — we would expect rain to cancel the festival, but it continued anyway. This is a classic contrast/concession structure.",
    "topic": "Sentence Function"
  },
  {
    "id": 13,
    ...
    "answer": 0,
    "explanation": "Choice A is correct. \"Despite\" signals concession/contrast. The setbacks would normally prevent completion, yet the project finished on time. This is a contrast, not a cause or solution.",
    "topic": "Sentence Function"
  },
  {
    "id": 14,
    ...
    "answer": 2,
    "explanation": "Choice C is correct. \"Given the limited budget\" is an absolute phrase that provides the reason or condition explaining why the team prioritized critical issues. It is not a contrast — the decision logically follows from the constraint.",
    "topic": "Sentence Function"
  },
  {
    "id": 15,
    ...
    "answer": 1,
    "explanation": "Choice B is correct. Option B adds specific, relevant detail directly tied to security improvement. Options A and C are vague and add little meaning. Option D shifts tone and introduces an unrelated idea about features.",
  ...
  },
  {
    ...
    "answer": 2,
    "explanation": "Choice C is correct. Option C pivots from the problem (challenges) to the solution (scientists working on fixes), making it the ideal transition. Options A, B, and D stay in the \"problem/background\" territory without moving toward solutions.",
    "topic": "Transitions & Conjunctions"
  },
  {
    "id": 17,
    ...
    "answer": 3,
    "explanation": "Choice D is correct. Option D directly addresses the impact of social media on communication with specific detail. The other options are either too vague (A, C) or tangentially related (B) without supporting the paragraph's central claim.",
    "topic": "Rhetorical Skills"
  },
  {
    "id": 18,
    ...
    "answer": 1,
    "explanation": "Choice B is correct. Option B makes the strongest direct claim about sleep's importance with specific health dimensions. Options A, C, and D are either anecdotal, exceptions, or general advice that don't directly support a claim about health importance.",
    "topic": "Rhetorical Skills"
  },
  {
    "id": 19,
    ...
    "answer": 0,
    "explanation": "Choice A is correct. Option A directly states the main point of the paragraph (benefits: career and cognitive). It serves as a clear topic sentence. Options B, C, and D address challenges, timing, and practice — not benefits.",
    "topic": "Rhetorical Skills"
  },
  {
    "id": 20,
    ...
    "answer": 1,
    "explanation": "Choice B is correct. Option B directly supports the topic of exercise benefits with three specific, evidence-based claims. Options A, C, and D are observations about habits or tangential advice, not arguments about benefits.",
    "topic": "Rhetorical Skills"
  },
  {
    "id": 21,
    ...
    "answer": 0,
    "explanation": "Choice A is correct. Option A reinforces the paragraph's argument by adding that economic benefits — in addition to environmental ones — make sustainable agriculture important. It broadens the case. Options B, C, and D introduce resistance, caution, and consumer preference that don't conclude the argument.",
    "topic": "Rhetorical Skills"
  },
  {
    "id": 22,
    ...
    "answer": 3,
    "explanation": "Choice D is correct. The passage states that electric car popularity has \"surged\" and gives three reasons. Option D accurately captures this main idea. Options A, B, and C contradict or distort what the passage actually says.",
  ...
  },
  {
    ...
    "answer": 3,
    "explanation": "Choice D is correct. The passage explicitly lists \"convenience\" and \"competitive prices\" as advantages of online shopping. Options A, B, and C either contradict the passage or mention things not stated as advantages.",
    "topic": "Reading Comprehension"
  },
  {
    "id": 24,
    ...
    "answer": 1,
    "explanation": "Choice B is correct. The passage directly states that renewable sources \"are essential for reducing greenhouse gas emissions.\" Option A contradicts cost advantages implied, C is too absolute, and D is factually wrong — renewables are the opposite of non-renewable.",
    "topic": "Reading Comprehension"
  },
  {
    "id": 25,
    ...
    "answer": 2,
    "explanation": "Choice C is correct. The original sentence has a dangling modifier — \"walking through the park\" must refer to a person, not flowers. Option C correctly places \"she\" as the subject performing the action. Options A and B retain the dangling modifier; D is awkward and ambiguous.",
    "topic": "Modifiers"
  }
];
